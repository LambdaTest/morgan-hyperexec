...
class FirstSampleTest(unittest.TestCase):
    ...
    def test_demo_site(self):
        ...
        try:
            ...
            # set the value of variable 'assertion_operand_6d2447270e5a4b1c9f8c5dab467ad5f5_0' to viewTerminationReasons
            lambda_hooks(driver, "set the value of variable 'assertion_operand_6d2447270e5a4b1c9f8c5dab467ad5f5_0' to viewTerminationReasons")
            ...
            # Query if '(10) Records found' text is visible
            lambda_hooks(driver, "Query if '(10) Records found' text is visible")
            ...
            # set the value of variable 'assertion_operand_f6c633a8554b451994b881376bf83cb6_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_f6c633a8554b451994b881376bf83cb6_0' to true")
