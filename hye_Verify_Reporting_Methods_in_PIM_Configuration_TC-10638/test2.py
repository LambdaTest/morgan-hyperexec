...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_b9f5fb1bd99f4a8e9eac8a3d65907a30_0' to true
    assertion_operand_b9f5fb1bd99f4a8e9eac8a3d65907a30_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 14 : set the value of variable 'assertion_operand_8006870af02242ad9a6ed8fd04905f45_0' to viewReportingMethods
    assertion_operand_8006870af02242ad9a6ed8fd04905f45_0 = "viewReportingMethods"
    driver.implicitly_wait(6)

    # Step - 15 : Assert '{{url}}' contains 'viewReportingMethods'
    assertion_operand_8006870af02242ad9a6ed8fd04905f45_0 = "viewReportingMethods"
    driver.implicitly_wait(6)

    # Step - 16 : Query if '(2) Records found' text is visible
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 17 : set the value of variable 'assertion_operand_0695f23757ab451bb2252774dbca8f04_0' to true
    assertion_operand_0695f23757ab451bb2252774dbca8f04_0 = "true"
    driver.implicitly_wait(6)

    # Step - 18 : Assert '(2) Records found' text is visible
    assertion_operand_0695f23757ab451bb2252774dbca8f04_0 = "true"
    driver.implicitly_wait(6)

    # Step - 19 : Query if 'Direct' text is visible
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 20 : set the value of variable 'assertion_operand_d6ed21ded9d34d80b7cf12386badc060_0' to true
    assertion_operand_d6ed21ded9d34d80b7cf12386badc060_0 = "true"
    driver.implicitly_wait(6)

    # Step - 21 : Assert 'Direct' text is visible on the viewport
    assertion_operand_d6ed21ded9d34d80b7cf12386badc060_0 = "true"
    driver.implicitly_wait(6)

    # Step - 22 : Query 'Indirect' text visibility
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 23 : set the value of variable 'assertion_operand_e264d79cfd8d4da496ee97f7d26e9e5e_0' to true
    assertion_operand_e264d79cfd8d4da496ee97f7d26e9e5e_0 = "true"
    driver.implicitly_wait(6)

    # Step - 24 : Assert 'Indirect' text is visible on the viewport
    assertion_operand_e264d79cfd8d4da496ee97f7d26e9e5e_0 = "true"
