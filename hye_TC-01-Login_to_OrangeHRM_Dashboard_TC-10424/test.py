...
from orangehrm_login_module_1_0 import orangehrm_login_module_1_0
...
class FirstSampleTest(unittest.TestCase):
    ...
    def test_demo_site(self):
        ...
        try:
            ...
            orangehrm_login_module_1_0(driver)

            reload_metadata_root()

            # Query 'Dashboard' text visibility
            lambda_hooks(driver, "Query 'Dashboard' text visibility")
            Dashboard_visible = vision_query(driver = driver, operation_index = str(0))
            ...
            # set the value of variable 'assertion_operand_04c5057e19b742929152d36a4bd91c5b_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_04c5057e19b742929152d36a4bd91c5b_0' to true")
