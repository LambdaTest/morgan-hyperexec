...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_ac4710c00cc44af58f601144d58f5278_0' to true
    assertion_operand_ac4710c00cc44af58f601144d58f5278_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 14 : Query if 'Required' text is visible
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 15 : set the value of variable 'assertion_operand_913da007dd164e8d8a144775c961bc8e_0' to true
    assertion_operand_913da007dd164e8d8a144775c961bc8e_0 = "true"
    driver.implicitly_wait(6)

    # Step - 16 : Assert 'Required' text is visible on the viewport
    assertion_operand_913da007dd164e8d8a144775c961bc8e_0 = "true"
    driver.implicitly_wait(6)

    # Step - 17 : Query 'Required' text visibility for 'SMTP Host'
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 18 : set the value of variable 'assertion_operand_64fd44b9c8354c0b8bc950fe28a1b0df_0' to true
    assertion_operand_64fd44b9c8354c0b8bc950fe28a1b0df_0 = "true"
    driver.implicitly_wait(6)

    # Step - 19 : Assert 'Required' text is displayed for 'SMTP Host'
    assertion_operand_64fd44b9c8354c0b8bc950fe28a1b0df_0 = "true"
