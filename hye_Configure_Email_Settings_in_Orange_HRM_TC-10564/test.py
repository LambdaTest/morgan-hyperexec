...
class FirstSampleTest(unittest.TestCase):
    ...
    def test_demo_site(self):
        ...
        try:
            ...
            required_visible = vision_query(driver = driver, operation_index = str(5))
            ...
            # set the value of variable 'assertion_operand_913da007dd164e8d8a144775c961bc8e_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_913da007dd164e8d8a144775c961bc8e_0' to true")
            ...
            # Query 'Required' text visibility for 'SMTP Host'
            lambda_hooks(driver, "Query 'Required' text visibility for 'SMTP Host'")
            ...
            # set the value of variable 'assertion_operand_64fd44b9c8354c0b8bc950fe28a1b0df_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_64fd44b9c8354c0b8bc950fe28a1b0df_0' to true")
