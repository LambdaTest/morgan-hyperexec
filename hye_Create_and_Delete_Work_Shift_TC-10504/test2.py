...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_bac3c344f2094962be5354215f1ed965_0' to true
    assertion_operand_bac3c344f2094962be5354215f1ed965_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 9 : Click 'Admin' menu item in the left sidebar
    ...
    # Step - 11 : Click 'Job' dropdown in the top nav bar
    ...
    # Step - 12 : Click 'Work Shifts' from the dropdown
    element_locators = ["//nav[@role='navigation' and @aria-label='Topbar Menu']/ul[1]/li[2]/ul[1]/li[5]/a[1]", "//a[text()='Work Shifts']", "//a[contains(text(),'Work Shifts')]", '[aria-label="Topbar Menu"] > ul:nth-child(1) > li:nth-child(2) > ul:nth-child(2) > li:nth-child(5) > a:nth-child(1)']
    element = get_element(driver,element_locators)
    ...
    # Step - 15 : type 'abc' in shift name
    ...
    # Step - 18 : Query if 'abc' text is displayed on the viewport
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 19 : set the value of variable 'assertion_operand_7382befebca64970a6e1e2d1488b8d66_0' to true
    assertion_operand_7382befebca64970a6e1e2d1488b8d66_0 = "true"
    driver.implicitly_wait(6)

    # Step - 20 : Assert 'abc' text is displayed on the viewport
    assertion_operand_7382befebca64970a6e1e2d1488b8d66_0 = "true"
    driver.implicitly_wait(6)

    # Step - 21 : Click 'delete' icon
    element_locators = ["//div[@id='app']/div[1]/div[2]/div[2]/div[1]/div[1]/div[3]/div[1]/div[2]/div[1]/div[1]/div[6]/div[1]/button[1]", '[role="table"] > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(6) > div:nth-child(1) > button:nth-child(1)']
    element = get_element(driver,element_locators)
    ...
    # Step - 22 : Click 'Yes,Delete' button
