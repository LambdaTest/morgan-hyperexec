...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_6c3f6320ae31424b89cdb7218813950d_0' to true
    assertion_operand_6c3f6320ae31424b89cdb7218813950d_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 10 : Click on the 'What's on your mind?' text area in Buzz Newsfeed
    ...
    # Step - 11 : Type in What's on your mind? input textarea 'new comment here'
    element_locators = ['[placeholder="What\'s on your mind?"]', '.oxd-buzz-post--focus > textarea', '.oxd-buzz-post--focus > textarea:nth-child(1)', '.oxd-buzz-post--focus > textarea:nth-child(1)', "//div[contains(@class,'oxd-buzz-post--focus')]/textarea[1]", "//div[contains(@class,'oxd-buzz-post--focus')]/textarea[1]"]
    element = get_element(driver,element_locators)
    ...
    driver.execute_script("arguments[0].value = '';", element)
    if element.get_attribute("pattern") and '[0-9]{2}' in element.get_attribute("pattern"):
        for char in 'new comment here':
            element.send_keys(char)
    else:
        element.send_keys('new comment here')
    driver.implicitly_wait(6)
    ...
    # Step - 13 : Click on the share icon below the comment by Pushpa Raj
    ...
    # Step - 14 : Click on the 'What's on your mind?' text area in share post popup
    element_locators = ['.oxd-buzz-post--focus > textarea', '.oxd-buzz-post--focus > textarea:nth-child(1)', '.oxd-buzz-post--focus > textarea:nth-child(1)', "//div[contains(@class,'oxd-buzz-post--focus')]/textarea[1]", "//div[contains(@class,'oxd-buzz-post--focus')]/textarea[1]"]
    element = get_element(driver,element_locators)
    ...
    # Step - 15 : Type in What's on your mind? text area 'sharing'
    element_locators = ['.oxd-buzz-post--focus > textarea', '.oxd-buzz-post--focus > textarea:nth-child(1)', '.oxd-buzz-post--focus > textarea:nth-child(1)', "//div[contains(@class,'oxd-buzz-post--focus')]/textarea[1]", "//div[contains(@class,'oxd-buzz-post--focus')]/textarea[1]"]
    element = get_element(driver,element_locators)
    ...
    if element.get_attribute("pattern") and '[0-9]{2}' in element.get_attribute("pattern"):
        ...
        element.send_keys('sharing')
    driver.implicitly_wait(6)

    # Step - 16 : Click on the Share button in Share Post popup
    ...
    # Step - 17 : Scroll document
    driver.execute_script("window.scrollBy(0, 97)")
    time.sleep(1)
    driver.implicitly_wait(6)

    # Step - 18 : Query '1 Share' text visibility
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 19 : set the value of variable 'assertion_operand_4b2a95e2e7a34906a0c173692a3bab9d_0' to true
    assertion_operand_4b2a95e2e7a34906a0c173692a3bab9d_0 = "true"
    driver.implicitly_wait(6)

    # Step - 20 : Assert '1 Share' text is visible
    assertion_operand_4b2a95e2e7a34906a0c173692a3bab9d_0 = "true"
    driver.implicitly_wait(6)

    # Step - 21 : Click on the three dots menu icon on the second post by Pushpa Raj
    element_locators = ["//div[@id='app']/div[1]/div[2]/div[2]/div[1]/div[1]/div[1]/div[3]/div[2]/div[1]/div[1]/div[1]/div[2]/li[1]/button[1]/i[1]", '#app > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(4) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > li:nth-child(1) > button:nth-child(1) > i:nth-child(1)']
    element = get_element(driver,element_locators)
    ...
    element_locators = ["//div[@id='app']/div[1]/div[2]/div[2]/div[1]/div[1]/div[1]/div[3]/div[2]/div[1]/div[1]/div[1]/div[2]/li[1]/ul[1]/li[1]/p[1]", "//p[text()='Delete Post']", '[role="menu"] > li:nth-child(1) > p:nth-child(2)', '[role="menu"] > li:nth-child(1) > p:nth-child(2)']
    element = get_element(driver,element_locators)
    ...
    # Step - 23 : Click on the Yes, Delete button with trash icon
