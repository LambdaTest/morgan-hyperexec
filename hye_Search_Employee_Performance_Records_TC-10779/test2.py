...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_c871f0db4a1845738bafa919a944f03a_0' to true
    assertion_operand_c871f0db4a1845738bafa919a944f03a_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 16 : Click on Include dropdown showing 'Current Employees Only'
    element_locators = ['.oxd-select-text--focus > div:nth-child(1)', '.oxd-select-text--focus > div:nth-child(1)', '.oxd-select-text--focus > div:nth-child(1)', 'div:has(+ .oxd-select-text--after)', "//div[text()='Current Employees Only']", "//div[contains(text(),'Current Employees Only')]", "//div[contains(@class,'oxd-select-text--focus')]/div[1]", "//div[contains(@class,'oxd-select-text--focus')]/div[1]"]
    element = get_element(driver,element_locators)
    ...
    # Step - 17 : Click on the Search button in employee performance trackers section
    ...
    # Step - 20 : set the value of variable 'assertion_operand_87e0db0fbdae466c89393c16c95a5386_0' to true
    ...
    # Step - 22 : Click on the Reset button in Employee Performance Trackers section
