...
class FirstSampleTest(unittest.TestCase):
    ...
    def test_demo_site(self):
        ...
        try:
            ...
            Invalid_visible = vision_query(driver = driver, operation_index = str(12))
            ...
            # set the value of variable 'assertion_operand_a399a22f2a3745c0b083e9341549b12d_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_a399a22f2a3745c0b083e9341549b12d_0' to true")
