...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_30fb3d259662407b84dbe832759aff87_0' to true
    assertion_operand_30fb3d259662407b84dbe832759aff87_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 14 : set the value of variable 'assertion_operand_097cea134616482088eab7fdc7005e4a_0' to viewJobVacancy
    assertion_operand_097cea134616482088eab7fdc7005e4a_0 = "viewJobVacancy"
    driver.implicitly_wait(6)

    # Step - 15 : Assert '{{url}}' contains 'viewJobVacancy'
    assertion_operand_097cea134616482088eab7fdc7005e4a_0 = "viewJobVacancy"
    driver.implicitly_wait(6)

    # Step - 16 : Query 'Vacancies' text visibility
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 17 : set the value of variable 'assertion_operand_9f4ae17494ed461ea2e92f9d6e669f65_0' to true
    assertion_operand_9f4ae17494ed461ea2e92f9d6e669f65_0 = "true"
    driver.implicitly_wait(6)

    # Step - 18 : Assert 'Vacancies' text is displayed
    assertion_operand_9f4ae17494ed461ea2e92f9d6e669f65_0 = "true"
    driver.implicitly_wait(6)

    # Step - 19 : Query if 'No Records Found' text is visible
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 20 : set the value of variable 'assertion_operand_3f79a44012a140b78addc48f846bc103_0' to true
    ...
    # Step - 22 : Query if 'No Records Found' text is visible
    ...
    # Step - 23 : set the value of variable 'assertion_operand_955120863b264d44b5bfc96395d71a71_0' to true
    assertion_operand_955120863b264d44b5bfc96395d71a71_0 = "true"
    driver.implicitly_wait(6)

    # Step - 24 : Assert 'No Records Found' text is visible
    assertion_operand_955120863b264d44b5bfc96395d71a71_0 = "true"
