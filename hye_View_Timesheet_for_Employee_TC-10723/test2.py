...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_fe671075316e4b7ca0595719e0a2990d_0' to true
    assertion_operand_fe671075316e4b7ca0595719e0a2990d_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 11 : type 'ayush' in employee name
    element_locators = ['[placeholder="Type for hints..."]', '.oxd-autocomplete-text-input--before + input', 'input:has(+ .oxd-autocomplete-text-input--after)', '.oxd-input-field-bottom-space > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > input:nth-child(2)', "//input[starts-with(@placeholder,'Type ')]", "//input[contains(@placeholder,'Type for hints...')]", "//div[contains(@class,'oxd-input-field-bottom-space')]/div[2]/div[1]/div[1]/input[1]", "//div[contains(@class,'oxd-input-field-bottom-space')]/div[2]/div[1]/div[1]/input[1]"]
    element = get_element(driver,element_locators)
    ...
    # Step - 13 : Click 'ayush pathania' from the dropdown
    ...
    # Step - 15 : Query if 'No Timesheets Found' text is visible
    element_locators = ['.oxd-alert-content--warn > p', '.oxd-alert-content--warn > p:nth-child(2)', '.oxd-alert-content--warn > p:nth-child(2)', "//p[text()='No Timesheets Found']", "//div[contains(@class,'oxd-alert-content--warn')]/p[1]", "//div[contains(@class,'oxd-alert-content--warn')]/p[1]"]
    element = get_element(driver,element_locators)

    'This Instruction Is Carried Out By The Vision Model'
    driver.implicitly_wait(6)

    # Step - 16 : set the value of variable 'assertion_operand_703477708bd14520a57e6f31505a3b87_0' to true
    assertion_operand_703477708bd14520a57e6f31505a3b87_0 = "true"
    driver.implicitly_wait(6)

    # Step - 17 : Assert 'No Timesheets Found' text is visible
    assertion_operand_703477708bd14520a57e6f31505a3b87_0 = "true"
    driver.implicitly_wait(6)

    # Step - 18 : Query if 'Ayush Pathania' text is visible
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 19 : set the value of variable 'assertion_operand_a6fae10458ba40a89d42bb24c502ff0f_0' to true
    assertion_operand_a6fae10458ba40a89d42bb24c502ff0f_0 = "true"
    driver.implicitly_wait(6)

    # Step - 20 : Assert 'Ayush Pathania' text is visible on viewport
    assertion_operand_a6fae10458ba40a89d42bb24c502ff0f_0 = "true"
    driver.implicitly_wait(6)

    # Step - 21 : Query 'Create Timesheet' text visibility
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 22 : set the value of variable 'assertion_operand_88ad1b025b154bf18e061ab5ed6947e2_0' to true
    assertion_operand_88ad1b025b154bf18e061ab5ed6947e2_0 = "true"
    driver.implicitly_wait(6)

    # Step - 23 : Assert 'Create Timesheet' text is visible
    assertion_operand_88ad1b025b154bf18e061ab5ed6947e2_0 = "true"
