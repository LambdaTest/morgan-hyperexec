...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_390b8aae26404eb9a6a57c77b8def7d1_0' to true
    assertion_operand_390b8aae26404eb9a6a57c77b8def7d1_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 16 : set the value of variable 'assertion_operand_efa8609e656f431dba9ef710b2182747_0' to true
    assertion_operand_efa8609e656f431dba9ef710b2182747_0 = "true"
    driver.implicitly_wait(6)
