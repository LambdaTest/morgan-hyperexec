...
class FirstSampleTest(unittest.TestCase):
    ...
    def test_demo_site(self):
        ...
        try:
            ...
            # Click 'Education' dropdown
            lambda_hooks(driver, "Click 'Education' dropdown")
            ...
            # set the value of variable 'assertion_operand_650455b15d52491f8d74f7efe57fe443_0' to viewEducation
            lambda_hooks(driver, "set the value of variable 'assertion_operand_650455b15d52491f8d74f7efe57fe443_0' to viewEducation")
            ...
            # Query if 'No Records Found' is visible
            lambda_hooks(driver, "Query if 'No Records Found' is visible")
            ...
            # set the value of variable 'assertion_operand_f3384b5beb4e45eb877011b9b831dfdb_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_f3384b5beb4e45eb877011b9b831dfdb_0' to true")
            ...
            add_button_visible = vision_query(driver = driver, operation_index = str(10))
            ...
            # set the value of variable 'assertion_operand_114a52ec971d4533b977f0ff814631ca_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_114a52ec971d4533b977f0ff814631ca_0' to true")
