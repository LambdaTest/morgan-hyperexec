...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_afdd55da62b34530915016e59a2fdcfb_0' to true
    assertion_operand_afdd55da62b34530915016e59a2fdcfb_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 11 : Upload file from variable '/home/kaneai/Downloads/Screenshot+2025-09-12+at+7.19.03%E2%80%AFPM.png'
    ...
    # Step - 12 : Click on the close button on share photos popup
