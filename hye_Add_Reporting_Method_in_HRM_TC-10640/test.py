...
class FirstSampleTest(unittest.TestCase):
    ...
    def test_demo_site(self):
        ...
        try:
            ...
            # Query 'Required' text color
            lambda_hooks(driver, "Query 'Required' text color")
            required_text_color = vision_query(driver = driver, operation_index = str(7))
            if isinstance(required_text_color, dict):
                required_text_color = required_text_color.get("vision_query")
            user_variables["required_text_color"] =  required_text_color
            print("required_text_color:", required_text_color)

            # set the value of variable 'assertion_operand_f8b1057037bc41dc8f2a6b23e4e1f3bd_0' to red
            lambda_hooks(driver, "set the value of variable 'assertion_operand_f8b1057037bc41dc8f2a6b23e4e1f3bd_0' to red")
