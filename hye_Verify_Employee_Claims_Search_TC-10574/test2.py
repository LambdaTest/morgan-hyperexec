...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_d6fd2db195b34458a94f2aa129a7f46d_0' to true
    assertion_operand_d6fd2db195b34458a94f2aa129a7f46d_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 11 : Click on the Search button in employee claims section 
    ...
    # Step - 12 : Query '(2) Records Found' visibility
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 13 : set the value of variable 'assertion_operand_2e4f746b68c3458abcd61b594a51f6b8_0' to true
    assertion_operand_2e4f746b68c3458abcd61b594a51f6b8_0 = "true"
    driver.implicitly_wait(6)

    # Step - 14 : Assert '(2) Records Found' text is visible
    assertion_operand_2e4f746b68c3458abcd61b594a51f6b8_0 = "true"
    driver.implicitly_wait(6)

    # Step - 15 : Query 'Ayush Pathania' visibility
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 16 : set the value of variable 'assertion_operand_a866f78f6a2e4e75be6f1a8f90bf15f3_0' to true
    assertion_operand_a866f78f6a2e4e75be6f1a8f90bf15f3_0 = "true"
    driver.implicitly_wait(6)

    # Step - 17 : Assert 'Ayush Pathania' is visible
    assertion_operand_a866f78f6a2e4e75be6f1a8f90bf15f3_0 = "true"
    driver.implicitly_wait(6)

    # Step - 18 : Query 'Pushpa Raj' text visibility
    ...
    # Step - 19 : set the value of variable 'assertion_operand_157faa7020c74ab1bb34d0841c25df71_0' to true
    assertion_operand_157faa7020c74ab1bb34d0841c25df71_0 = "true"
    driver.implicitly_wait(6)

    # Step - 20 : Assert 'Pushpa Raj' text is visible
    assertion_operand_157faa7020c74ab1bb34d0841c25df71_0 = "true"
    driver.implicitly_wait(6)

    # Step - 21 : Query 'Active Evenet' visibility
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 22 : set the value of variable 'assertion_operand_dfc483f649cc42cf89907f025a134e19_0' to true
    assertion_operand_dfc483f649cc42cf89907f025a134e19_0 = "true"
    driver.implicitly_wait(6)

    # Step - 23 : Assert 'Active Evenet' is visible
    assertion_operand_dfc483f649cc42cf89907f025a134e19_0 = "true"
    driver.implicitly_wait(6)

    # Step - 24 : Query 'View Details' visibility
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 25 : set the value of variable 'assertion_operand_9dbd4a4c03f04af68eefb8ff66f52431_0' to true
    assertion_operand_9dbd4a4c03f04af68eefb8ff66f52431_0 = "true"
    driver.implicitly_wait(6)

    # Step - 26 : Assert 'View Details' is visible
    assertion_operand_9dbd4a4c03f04af68eefb8ff66f52431_0 = "true"
    driver.implicitly_wait(6)

    # Step - 27 : Query 'Afghanistan' text visibility
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 28 : set the value of variable 'assertion_operand_28b4cb4c5e964cf1873fc33f1e6c2282_0' to true
    assertion_operand_28b4cb4c5e964cf1873fc33f1e6c2282_0 = "true"
    driver.implicitly_wait(6)

    # Step - 29 : Assert 'Afghanistan' text is visible
    assertion_operand_28b4cb4c5e964cf1873fc33f1e6c2282_0 = "true"
    driver.implicitly_wait(6)

    # Step - 30 : Query 'Afghani' text visibility
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 31 : set the value of variable 'assertion_operand_7a95b8265c4a42ba8ee145219ee18de9_0' to true
    assertion_operand_7a95b8265c4a42ba8ee145219ee18de9_0 = "true"
    driver.implicitly_wait(6)

    # Step - 32 : Assert 'Afghani' text is visible
    assertion_operand_7a95b8265c4a42ba8ee145219ee18de9_0 = "true"
