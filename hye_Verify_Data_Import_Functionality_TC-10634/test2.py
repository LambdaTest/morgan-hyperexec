...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_684f441ad93d40afb96eb867205ad439_0' to true
    assertion_operand_684f441ad93d40afb96eb867205ad439_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 13 : Query 'Browse' text visibility
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 14 : set the value of variable 'assertion_operand_da4ee21bc71f4028929653bec4a77bb0_0' to true
    assertion_operand_da4ee21bc71f4028929653bec4a77bb0_0 = "true"
    driver.implicitly_wait(6)

    # Step - 15 : Assert 'Browse' text is visible
    assertion_operand_da4ee21bc71f4028929653bec4a77bb0_0 = "true"
    driver.implicitly_wait(6)

    # Step - 16 : Query visibility of text 'Accepts up to 1MB'
    element_locators = ['.oxd-grid-item--gutters > p', '.oxd-grid-item--gutters > p:nth-child(2)', '.oxd-grid-item--gutters > p:nth-child(2)', '.oxd-input-field-bottom-space + p', "//p[text()='Accepts up to 1MB']", "//div[contains(@class,'oxd-grid-item--gutters')]/p[1]", "//div[contains(@class,'oxd-grid-item--gutters')]/p[1]"]
    element = get_element(driver,element_locators)

    'This Instruction Is Carried Out By The Vision Model'
    driver.implicitly_wait(6)

    # Step - 17 : set the value of variable 'assertion_operand_aeff4baf8556423497139dcc9b11b6c6_0' to true
    assertion_operand_aeff4baf8556423497139dcc9b11b6c6_0 = "true"
    driver.implicitly_wait(6)

    # Step - 18 : Assert text 'Accepts up to 1MB' is visible on viewport
    assertion_operand_aeff4baf8556423497139dcc9b11b6c6_0 = "true"
    driver.implicitly_wait(6)

    # Step - 19 : Click 'Upload' button
    ...
    # Step - 20 : Query if 'Required' text is visible
    ...
    # Step - 21 : set the value of variable 'assertion_operand_d2cbf461689e4321bb5d4de230df11be_0' to true
    assertion_operand_d2cbf461689e4321bb5d4de230df11be_0 = "true"
    driver.implicitly_wait(6)

    # Step - 22 : Assert 'Required' text is visible on viewport
    assertion_operand_d2cbf461689e4321bb5d4de230df11be_0 = "true"
