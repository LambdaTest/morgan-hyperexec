...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_0353b0c884fa48309db3a5b319eadc10_0' to true
    assertion_operand_0353b0c884fa48309db3a5b319eadc10_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 11 : Click 'Contact Details' tab in left side menu under 'Personal Details'
    ...
    # Step - 13 : Click on 'Add' button below Attachments section
    ...
    # Step - 14 : scroll down once
    driver.execute_script(f"scroll_height = 1*window.innerHeight; window.scrollBy(0, scroll_height)")
    time.sleep(1)
    driver.implicitly_wait(6)

    # Step - 15 : Upload file from variable '/home/kaneai/Downloads/Screenshot+2025-09-12+at+7.19.03%E2%80%AFPM.png'
    ...
    # Step - 16 : Query 'Add Attachment' visibility
    ...
    # Step - 17 : set the value of variable 'assertion_operand_c903a6f4b04340bb87e0d4748d7f60d9_0' to true
    assertion_operand_c903a6f4b04340bb87e0d4748d7f60d9_0 = "true"
    driver.implicitly_wait(6)

    # Step - 18 : Assert 'Add Attachment' text is visible
    assertion_operand_c903a6f4b04340bb87e0d4748d7f60d9_0 = "true"
    driver.implicitly_wait(6)

    # Step - 19 : Query 'Select File' visibility
    ...
    # Step - 20 : set the value of variable 'assertion_operand_833be9bea86447a0b1096f4b0854ee0e_0' to true
    assertion_operand_833be9bea86447a0b1096f4b0854ee0e_0 = "true"
    driver.implicitly_wait(6)

    # Step - 21 : Assert 'Select File' text is visible
    assertion_operand_833be9bea86447a0b1096f4b0854ee0e_0 = "true"
    driver.implicitly_wait(6)

    # Step - 22 : Query 'Browse' text visibility
    ...
    # Step - 23 : set the value of variable 'assertion_operand_13e4edcb6c344cacaf0cd0b9bba548a1_0' to true
    assertion_operand_13e4edcb6c344cacaf0cd0b9bba548a1_0 = "true"
    driver.implicitly_wait(6)

    # Step - 24 : Assert 'Browse' text is visible
    assertion_operand_13e4edcb6c344cacaf0cd0b9bba548a1_0 = "true"
    driver.implicitly_wait(6)

    # Step - 25 : Query 'Comment' text visibility
    element_locators = ["//div[@id='app']/div[1]/div[2]/div[2]/div[1]/div[1]/div[1]/div[2]/div[2]/div[1]/form[1]/div[2]/div[1]/div[1]/div[1]/div[1]/label[1]", '#app > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(2) > form:nth-child(3) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > label:nth-child(1)', "//label[text()='Comment']", "//label[contains(text(),'Comment')]"]
    element = get_element(driver,element_locators)

    'This Instruction Is Carried Out By The Vision Model'
    driver.implicitly_wait(6)

    # Step - 26 : set the value of variable 'assertion_operand_c0b18ea91aec4a6cb04db0917e17b7c2_0' to true
    assertion_operand_c0b18ea91aec4a6cb04db0917e17b7c2_0 = "true"
    driver.implicitly_wait(6)

    # Step - 27 : Assert 'Comment' text is visible
    assertion_operand_c0b18ea91aec4a6cb04db0917e17b7c2_0 = "true"
    driver.implicitly_wait(6)

    # Step - 28 : Query 'Cancel' text visibility
    ...
    # Step - 29 : set the value of variable 'assertion_operand_70f3680bb8fa4e5ca671af5805c7326d_0' to true
    assertion_operand_70f3680bb8fa4e5ca671af5805c7326d_0 = "true"
    driver.implicitly_wait(6)

    # Step - 30 : Assert 'Cancel' text is visible
    assertion_operand_70f3680bb8fa4e5ca671af5805c7326d_0 = "true"
    driver.implicitly_wait(6)

    # Step - 31 : Query 'Save' text visibility
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 32 : set the value of variable 'assertion_operand_e7f8a88e5f0f496eafb85900d8d4b8f0_0' to true
    assertion_operand_e7f8a88e5f0f496eafb85900d8d4b8f0_0 = "true"
    driver.implicitly_wait(6)

    # Step - 33 : Assert 'Save' text is visible
    assertion_operand_e7f8a88e5f0f496eafb85900d8d4b8f0_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 35 : Query 'No Records Found' visibility
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 36 : set the value of variable 'assertion_operand_9abac0840db541c1b87fae0f9bcb295e_0' to true
    assertion_operand_9abac0840db541c1b87fae0f9bcb295e_0 = "true"
    driver.implicitly_wait(6)

    # Step - 37 : Assert 'No Records Found' text is visible
    assertion_operand_9abac0840db541c1b87fae0f9bcb295e_0 = "true"
