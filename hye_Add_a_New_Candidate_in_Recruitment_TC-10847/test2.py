...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_7fc5ca5e29404caeb0ea9346ada2367f_0' to true
    assertion_operand_7fc5ca5e29404caeb0ea9346ada2367f_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 15 : scroll up once
    driver.execute_script(f"scroll_height = 1*window.innerHeight; window.scrollBy(0, scroll_height)")
    time.sleep(1)
    driver.implicitly_wait(6)

    # Step - 16 : Query if 'Required' text is visible
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 17 : set the value of variable 'assertion_operand_f67b8212426b4c51a2b472129f041f1c_0' to true
    assertion_operand_f67b8212426b4c51a2b472129f041f1c_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 19 : Get the current URL
    current_url = driver.current_url

    print("current_url:", current_url)
    driver.implicitly_wait(6)

    # Step - 20 : set the value of variable 'assertion_operand_97e1e62ec172487c97390fc44a835fd4_0' to addCandidate
    assertion_operand_97e1e62ec172487c97390fc44a835fd4_0 = "addCandidate"
    driver.implicitly_wait(6)

    # Step - 21 : Assert '{{url}}' contains 'addCandidate'
    assertion_operand_97e1e62ec172487c97390fc44a835fd4_0 = "addCandidate"
