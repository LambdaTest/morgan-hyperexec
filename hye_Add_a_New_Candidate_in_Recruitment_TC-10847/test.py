...
class FirstSampleTest(unittest.TestCase):
    ...
    def test_demo_site(self):
        ...
        try:
            ...
            # scroll up once
            lambda_hooks(driver, "scroll up once")
            ...
            required_text_visible = vision_query(driver = driver, operation_index = str(7))
            ...
            # set the value of variable 'assertion_operand_f67b8212426b4c51a2b472129f041f1c_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_f67b8212426b4c51a2b472129f041f1c_0' to true")
            ...
            # set the value of variable 'assertion_operand_97e1e62ec172487c97390fc44a835fd4_0' to addCandidate
            lambda_hooks(driver, "set the value of variable 'assertion_operand_97e1e62ec172487c97390fc44a835fd4_0' to addCandidate")
