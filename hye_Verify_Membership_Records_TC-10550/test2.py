...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_8ce0f2cfa374410b8001756347912bf2_0' to true
    assertion_operand_8ce0f2cfa374410b8001756347912bf2_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 14 : set the value of variable 'assertion_operand_46aa99f6182e4c84b1c22ae0b78a6d8b_0' to membership
    assertion_operand_46aa99f6182e4c84b1c22ae0b78a6d8b_0 = "membership"
    driver.implicitly_wait(6)

    # Step - 15 : Assert '{{url}}' contains 'membership'
    assertion_operand_46aa99f6182e4c84b1c22ae0b78a6d8b_0 = "membership"
    driver.implicitly_wait(6)
    ...
    # Step - 17 : set the value of variable 'assertion_operand_1577d3a7bb1a4aa3893360e83aef04d3_0' to true
    assertion_operand_1577d3a7bb1a4aa3893360e83aef04d3_0 = "true"
    driver.implicitly_wait(6)
