...
class FirstSampleTest(unittest.TestCase):
    ...
    def test_demo_site(self):
        ...
        try:
            ...
            # Click 'Membership' dropdown
            lambda_hooks(driver, "Click 'Membership' dropdown")
            ...
            # set the value of variable 'assertion_operand_46aa99f6182e4c84b1c22ae0b78a6d8b_0' to membership
            lambda_hooks(driver, "set the value of variable 'assertion_operand_46aa99f6182e4c84b1c22ae0b78a6d8b_0' to membership")
            ...
            # set the value of variable 'assertion_operand_1577d3a7bb1a4aa3893360e83aef04d3_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_1577d3a7bb1a4aa3893360e83aef04d3_0' to true")
