...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_809e21ce52b64b9ea7db0d8de0a3c13f_0' to true
    assertion_operand_809e21ce52b64b9ea7db0d8de0a3c13f_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 13 : Query if 'Required' text is visible
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 14 : set the value of variable 'assertion_operand_636a9b1888154f90aadf3899af7db6e3_0' to true
    assertion_operand_636a9b1888154f90aadf3899af7db6e3_0 = "true"
    driver.implicitly_wait(6)

    # Step - 15 : Assert 'Required' text is displayed on viewport
    assertion_operand_636a9b1888154f90aadf3899af7db6e3_0 = "true"
    driver.implicitly_wait(6)

    # Step - 16 : Click 'Cancel' button
    ...
    # Step - 17 : Query if 'ayush' text is displayed on the viewport
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 18 : set the value of variable 'assertion_operand_863a198cd42049b4ab768ba45db80bc1_0' to true
    assertion_operand_863a198cd42049b4ab768ba45db80bc1_0 = "true"
    driver.implicitly_wait(6)

    # Step - 19 : Assert 'ayush' text is displayed on the viewport
    assertion_operand_863a198cd42049b4ab768ba45db80bc1_0 = "true"
