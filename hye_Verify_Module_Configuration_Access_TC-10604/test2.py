...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_5c07210547de4c20967c9a0169393afe_0' to true
    assertion_operand_5c07210547de4c20967c9a0169393afe_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 14 : set the value of variable 'assertion_operand_71f3d630aacf4605aa9cd2b945632613_0' to viewModules
    assertion_operand_71f3d630aacf4605aa9cd2b945632613_0 = "viewModules"
    driver.implicitly_wait(6)

    # Step - 15 : Assert '{{url}}' contains 'viewModules'
    assertion_operand_71f3d630aacf4605aa9cd2b945632613_0 = "viewModules"
    driver.implicitly_wait(6)

    # Step - 16 : Query 'Module Configuration' text visibility
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 17 : set the value of variable 'assertion_operand_3d516f54bfde4a50a544114b0c1269e4_0' to true
    assertion_operand_3d516f54bfde4a50a544114b0c1269e4_0 = "true"
    driver.implicitly_wait(6)

    # Step - 18 : Assert 'Module Configuration' text is visible
    assertion_operand_3d516f54bfde4a50a544114b0c1269e4_0 = "true"
