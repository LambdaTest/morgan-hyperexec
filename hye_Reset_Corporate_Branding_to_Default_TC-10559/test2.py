...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_8e33d518831a44dfb4d950d58e303bf7_0' to true
    assertion_operand_8e33d518831a44dfb4d950d58e303bf7_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 12 : Query if 'Reset to Default' text is visible
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 13 : set the value of variable 'assertion_operand_41dad5cc043e47338340176a39c6e4e4_0' to true
    assertion_operand_41dad5cc043e47338340176a39c6e4e4_0 = "true"
    driver.implicitly_wait(6)

    # Step - 14 : Assert 'Reset to Default' text is visible
    assertion_operand_41dad5cc043e47338340176a39c6e4e4_0 = "true"
    driver.implicitly_wait(6)

    # Step - 15 : Click 'Preview' button
    element_locators = ['button:has(+ .oxd-button--secondary)', "//div[@id='app']/div[1]/div[2]/div[2]/div[1]/div[1]/form[1]/div[4]/div[1]/button[2]", '#app > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > form:nth-child(3) > div:nth-child(8) > div:nth-child(2) > button:nth-child(2)', 'button:has(+ .oxd-button--medium.oxd-button--secondary)', 'button:has(+ [type="submit"])']
    element = get_element(driver,element_locators)
    ...
    # Step - 17 : Click 'Reset to Default'
    element_locators = ["//div[@id='app']/div[1]/div[2]/div[2]/div[1]/div[1]/form[1]/div[4]/div[1]/button[1]", '#app > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > form:nth-child(3) > div:nth-child(8) > div:nth-child(2) > button:nth-child(1)']
    element = get_element(driver,element_locators)
