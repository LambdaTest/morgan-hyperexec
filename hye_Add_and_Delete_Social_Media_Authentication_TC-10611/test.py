...
class FirstSampleTest(unittest.TestCase):
    ...
    def test_demo_site(self):
        ...
        try:
            ...
            abc_visible = vision_query(driver = driver, operation_index = str(12))
            ...
            # set the value of variable 'assertion_operand_afb103e864454b10b0d00ee0ddb1eb84_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_afb103e864454b10b0d00ee0ddb1eb84_0' to true")
            ...
            # wait 15 seconds
            lambda_hooks(driver, "wait 15 seconds")
