...
class FirstSampleTest(unittest.TestCase):
    ...
    def test_demo_site(self):
        ...
        try:
            ...
            # Click 'Custom Fields dropdown'
            lambda_hooks(driver, "Click 'Custom Fields dropdown'")
            ...
            # set the value of variable 'assertion_operand_2579900c7cf94685bd5cddf46f8ae437_0' to listCustomFields
            lambda_hooks(driver, "set the value of variable 'assertion_operand_2579900c7cf94685bd5cddf46f8ae437_0' to listCustomFields")
            ...
            # set the value of variable 'assertion_operand_0217298a5a4948c1ae80910ec2585e91_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_0217298a5a4948c1ae80910ec2585e91_0' to true")
