...
class FirstSampleTest(unittest.TestCase):
    ...
    def test_demo_site(self):
        ...
        try:
            ...
            # Click on 'Job' dropdown in the top nav bar
            lambda_hooks(driver, "Click on 'Job' dropdown in the top nav bar")
            ui_action(driver = driver, operation_index = str(2))

            # Click on 'Job Titles' tab in the top nav bar
            lambda_hooks(driver, "Click on 'Job Titles' tab in the top nav bar")
            ui_action(driver = driver, operation_index = str(3))

            # Click on the Add button in the System Users section
            lambda_hooks(driver, "Click on the Add button in the System Users section")
            ...
            # set the value of variable 'assertion_operand_1758d0b5350b426697572815aa3b7090_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_1758d0b5350b426697572815aa3b7090_0' to true")
            ...
            # type 'abc' in Add Job Title section
            ...
            # Query if 'abc' text is displayed on the viewport
            lambda_hooks(driver, "Query if 'abc' text is displayed on the viewport")
            abc_visible = vision_query(driver = driver, operation_index = str(14))
            ...
            # set the value of variable 'assertion_operand_cf23aaf8c1d74483b73c8b603550386b_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_cf23aaf8c1d74483b73c8b603550386b_0' to true")
            ...
            no_records_found_visible = vision_query(driver = driver, operation_index = str(20))
            ...
            # set the value of variable 'assertion_operand_511d4a9d7d984492a6f005793a0e1731_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_511d4a9d7d984492a6f005793a0e1731_0' to true")
