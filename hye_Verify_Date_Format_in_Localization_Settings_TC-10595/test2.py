...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_68d610ca6f034ca4864e2dd519b95eb5_0' to true
    assertion_operand_68d610ca6f034ca4864e2dd519b95eb5_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 13 : Click 'Date format' dropdown
    element_locators = ["//div[@id='app']/div[1]/div[2]/div[2]/div[1]/div[1]/form[1]/div[2]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]", '#app > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > form:nth-child(3) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1)', "//div[text()='yyyy-mm-dd ( 2025-09-13 )']", "//div[contains(text(),'yyyy-mm-dd ( 2025-09-13 )')]"]
    element = get_element(driver,element_locators)
    ...
    # Step - 14 : Click '{{smart.current_date}}' from the dropdown
    ...
    # Step - 15 : Query visibility of '{{smart.current_date}}' on viewport
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 16 : set the value of variable 'assertion_operand_6658986abf154d87a99297fcd2568634_0' to true
    assertion_operand_6658986abf154d87a99297fcd2568634_0 = "true"
    driver.implicitly_wait(6)

    # Step - 17 : Assert '{{smart.current_date}}' is visible on viewport
    assertion_operand_6658986abf154d87a99297fcd2568634_0 = "true"
