...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_1fad0693740a4c1c9710d5aa4861c70b_0' to true
    assertion_operand_1fad0693740a4c1c9710d5aa4861c70b_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 18 : set the value of variable 'assertion_operand_9ed25e9f0e0541db87aef13e63f6c130_0' to true
    ...
    # Step - 21 : wait 8 seconds
    time.sleep(int(8))
    driver.implicitly_wait(6)

    # Step - 22 : Query 'No Record Found' text visibility
    ...
    # Step - 23 : set the value of variable 'assertion_operand_a858d3d5024c44e2bfb2dd8bf88ade98_0' to true
    assertion_operand_a858d3d5024c44e2bfb2dd8bf88ade98_0 = "true"
    driver.implicitly_wait(6)

    # Step - 24 : Assert 'No Record Found' text is displayed
    assertion_operand_a858d3d5024c44e2bfb2dd8bf88ade98_0 = "true"
