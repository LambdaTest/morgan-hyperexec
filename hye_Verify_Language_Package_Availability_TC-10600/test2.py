...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_00960d0d515a432c868bf88f0606bcbb_0' to true
    assertion_operand_00960d0d515a432c868bf88f0606bcbb_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 13 : Query if 'Chinese' text is displayed
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 14 : set the value of variable 'assertion_operand_f9522b64ed8241c2a5fecd2d0a3d32ad_0' to true
    assertion_operand_f9522b64ed8241c2a5fecd2d0a3d32ad_0 = "true"
    driver.implicitly_wait(6)

    # Step - 15 : Assert 'Chinese' text is displayed
    assertion_operand_f9522b64ed8241c2a5fecd2d0a3d32ad_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 18 : Query 'Spanish' text visibility
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 19 : set the value of variable 'assertion_operand_9b4d5793d06446cba3062024021044a8_0' to true
    assertion_operand_9b4d5793d06446cba3062024021044a8_0 = "true"
    driver.implicitly_wait(6)

    # Step - 20 : Assert 'Spanish' text is visible on the viewport
    assertion_operand_9b4d5793d06446cba3062024021044a8_0 = "true"
