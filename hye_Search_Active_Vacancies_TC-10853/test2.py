...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_80a234087c5a46d2b794d842b0617ebb_0' to true
    ...
    # Step - 14 : Click 'Active' in dropdown
    ...
    # Step - 17 : Query if 'active' text is displayed
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 18 : set the value of variable 'assertion_operand_9ff8805523234d569ce908936a13566c_0' to true
    assertion_operand_9ff8805523234d569ce908936a13566c_0 = "true"
    driver.implicitly_wait(6)

    # Step - 19 : Assert 'active' text is displayed on viewport
    assertion_operand_9ff8805523234d569ce908936a13566c_0 = "true"
    driver.implicitly_wait(6)
