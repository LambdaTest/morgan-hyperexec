...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_71f45a289f184209a9600a824ecaa990_0' to true
    assertion_operand_71f45a289f184209a9600a824ecaa990_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 12 : Click 'Customers'
    element_locators = ["//nav[@role='navigation' and @aria-label='Topbar Menu']/ul[1]/li[4]/ul[1]/li[1]/a[1]", "//a[text()='Customers']", '[role="menu"] > li:nth-child(1) > a:nth-child(1)', '[role="menu"] > li:nth-child(1) > a:nth-child(1)', "//a[contains(text(),'Customers')]"]
    element = get_element(driver,element_locators)
    ...
    # Step - 14 : set the value of variable 'assertion_operand_be903d7162c2490e8a315fb420bf53b7_0' to viewCustomers
    assertion_operand_be903d7162c2490e8a315fb420bf53b7_0 = "viewCustomers"
    driver.implicitly_wait(6)

    # Step - 15 : Assert '{{url}}' contains 'viewCustomers'
    assertion_operand_be903d7162c2490e8a315fb420bf53b7_0 = "viewCustomers"
    driver.implicitly_wait(6)

    # Step - 16 : Query 'No Record Found' text visibility
    ...
    # Step - 17 : set the value of variable 'assertion_operand_29c5aa6757214b1e8eeea8e9cd87af03_0' to true
    assertion_operand_29c5aa6757214b1e8eeea8e9cd87af03_0 = "true"
    driver.implicitly_wait(6)

    # Step - 18 : Assert 'No Record Found' text is displayed
    assertion_operand_29c5aa6757214b1e8eeea8e9cd87af03_0 = "true"
    driver.implicitly_wait(6)

    # Step - 19 : Query 'Customers' text visibility
    element_locators = ["//div[@id='app']/div[1]/div[2]/div[2]/div[1]/div[1]/div[1]/h6[1]", '#app > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > h6:nth-child(1)', "//h6[text()='Customers']"]
    element = get_element(driver,element_locators)

    'This Instruction Is Carried Out By The Vision Model'
    driver.implicitly_wait(6)

    # Step - 20 : set the value of variable 'assertion_operand_8de14320b06d4a708842ccd6f78d133c_0' to true
    assertion_operand_8de14320b06d4a708842ccd6f78d133c_0 = "true"
    driver.implicitly_wait(6)

    # Step - 21 : Assert 'Customers' text is displayed on viewport
    assertion_operand_8de14320b06d4a708842ccd6f78d133c_0 = "true"
