...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_ae10ec034f0044ff9bc96230d95b1c88_0' to true
    assertion_operand_ae10ec034f0044ff9bc96230d95b1c88_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 19 : Query 'Already exists' text visibility
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 20 : set the value of variable 'assertion_operand_b22079f97e05465780bc23e880b74459_0' to true
    assertion_operand_b22079f97e05465780bc23e880b74459_0 = "true"
    driver.implicitly_wait(6)

    # Step - 21 : Assert 'Already exists' text is visible
    assertion_operand_b22079f97e05465780bc23e880b74459_0 = "true"
    driver.implicitly_wait(6)
