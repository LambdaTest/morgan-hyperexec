...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_922c80ffb4f54b7caa4cd9546edfa6d7_0' to true
    assertion_operand_922c80ffb4f54b7caa4cd9546edfa6d7_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 13 : Click 'enable' toggle button for first leave application
    element_locators = ["//div[@id='app']/div[1]/div[2]/div[2]/div[1]/div[1]/div[3]/div[1]/div[2]/div[1]/div[1]/div[3]/div[1]/div[1]/label[1]/input[1]", '[role="table"] > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(3) > div:nth-child(1) > div:nth-child(2) > label:nth-child(1) > input:nth-child(1)']
    element = get_element(driver,element_locators)
    ...
    # Step - 14 : Click 'disable' toggle button for first leave application
    element_locators = ["//div[@id='app']/div[1]/div[2]/div[2]/div[1]/div[1]/div[3]/div[1]/div[2]/div[1]/div[1]/div[3]/div[1]/div[1]/label[1]/input[1]", '[role="table"] > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(3) > div:nth-child(1) > div:nth-child(2) > label:nth-child(1) > input:nth-child(1)']
    element = get_element(driver,element_locators)
