...
class FirstSampleTest(unittest.TestCase):
    ...
    def test_demo_site(self):
        ...
        try:
            ...
            # Click 'enable' toggle button for first leave application
            lambda_hooks(driver, "Click 'enable' toggle button for first leave application")
            ui_action(driver = driver, operation_index = str(4))

            # Click 'disable' toggle button for first leave application
            lambda_hooks(driver, "Click 'disable' toggle button for first leave application")
