...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_a6981889aa544eb1a2a17e1008eb2b0e_0' to true
    assertion_operand_a6981889aa544eb1a2a17e1008eb2b0e_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 17 : set the value of variable 'assertion_operand_6c331ef182b94b85854cd402be5d4e75_0' to true
    assertion_operand_6c331ef182b94b85854cd402be5d4e75_0 = "true"
    driver.implicitly_wait(6)

    # Step - 18 : Assert 'Required' text is visible on viewport
    assertion_operand_6c331ef182b94b85854cd402be5d4e75_0 = "true"
