...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_3070be8608424d7db3441aea2cbf7069_0' to true
    assertion_operand_3070be8608424d7db3441aea2cbf7069_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 10 : Click on 'Configuration' dropdown in the top left navigation bar
    ...
    # Step - 11 : Click on 'Events' option in the Configuration dropdown
    ...
    # Step - 12 : Query 'Events' text visibility
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 13 : set the value of variable 'assertion_operand_6384017f03904527a774d674555ab912_0' to true
    assertion_operand_6384017f03904527a774d674555ab912_0 = "true"
    driver.implicitly_wait(6)

    # Step - 14 : Assert 'Events' text is visible
    assertion_operand_6384017f03904527a774d674555ab912_0 = "true"
    driver.implicitly_wait(6)

    # Step - 15 : Query 'Event Name' visibility
    element_locators = ["//div[@id='app']/div[1]/div[2]/div[2]/div[1]/div[2]/form[1]/div[1]/div[1]/div[1]/div[1]/div[1]/label[1]", '#app > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(3) > form:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > label:nth-child(1)', "//label[text()='Event Name']", "//label[contains(text(),'Event Name')]"]
    element = get_element(driver,element_locators)

    'This Instruction Is Carried Out By The Vision Model'
    driver.implicitly_wait(6)

    # Step - 16 : set the value of variable 'assertion_operand_c8d2c1fe5adc463787def4d7e6ca3620_0' to true
    assertion_operand_c8d2c1fe5adc463787def4d7e6ca3620_0 = "true"
    driver.implicitly_wait(6)

    # Step - 17 : Assert 'Event Name' is visible
    assertion_operand_c8d2c1fe5adc463787def4d7e6ca3620_0 = "true"
    driver.implicitly_wait(6)

    # Step - 18 : Query 'Reset' text visibility
    ...
    # Step - 19 : set the value of variable 'assertion_operand_959681f1ee6641c2ae8f5e0158c95fbe_0' to true
    assertion_operand_959681f1ee6641c2ae8f5e0158c95fbe_0 = "true"
    driver.implicitly_wait(6)

    # Step - 20 : Assert 'Reset' text is visible
    assertion_operand_959681f1ee6641c2ae8f5e0158c95fbe_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 22 : set the value of variable 'assertion_operand_e24f9be6f0354ccbb1d717933cf43119_0' to true
    ...
    # Step - 24 : Query 'Status' text visibility
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 25 : set the value of variable 'assertion_operand_d09b4054f5874117872f186544d43c94_0' to true
    assertion_operand_d09b4054f5874117872f186544d43c94_0 = "true"
    driver.implicitly_wait(6)

    # Step - 26 : Assert 'Status' text is visible
    assertion_operand_d09b4054f5874117872f186544d43c94_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 28 : set the value of variable 'assertion_operand_7b214c3b6a9d45c581bcf09ca8586337_0' to true
