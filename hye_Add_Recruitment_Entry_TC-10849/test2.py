...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_58a8acebece045ea9082f1495c026349_0' to true
    assertion_operand_58a8acebece045ea9082f1495c026349_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 13 : Query if '{{smart.current_date}}' is displayed on the viewport
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 14 : set the value of variable 'assertion_operand_b72a35c8ab2642009f4722d2628c9ade_0' to true
    assertion_operand_b72a35c8ab2642009f4722d2628c9ade_0 = "true"
    driver.implicitly_wait(6)

    # Step - 15 : Assert '{{smart.current_date}}' is displayed on the viewport
    assertion_operand_b72a35c8ab2642009f4722d2628c9ade_0 = "true"
