...
class FirstSampleTest(unittest.TestCase):
    ...
    def test_demo_site(self):
        ...
        try:
            ...
            # Query if '{{{{smart.current_date}}}}' is displayed on the viewport
            lambda_hooks(driver, "Query if '{{smart.current_date}}' is displayed on the viewport")
            ...
            # set the value of variable 'assertion_operand_b72a35c8ab2642009f4722d2628c9ade_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_b72a35c8ab2642009f4722d2628c9ade_0' to true")
            assertion_operand_b72a35c8ab2642009f4722d2628c9ade_0 = "true"
