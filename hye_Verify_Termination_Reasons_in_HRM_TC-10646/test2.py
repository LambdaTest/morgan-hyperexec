...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_b7878323b1bd41ee8ed75db4656ab879_0' to true
    assertion_operand_b7878323b1bd41ee8ed75db4656ab879_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 13 : Query 'Contract Not Renewed' text visibility
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 14 : set the value of variable 'assertion_operand_c1f43f8d19ba4049ae9a779373261eea_0' to true
    assertion_operand_c1f43f8d19ba4049ae9a779373261eea_0 = "true"
    driver.implicitly_wait(6)

    # Step - 15 : Assert 'Contract Not Renewed' text is visible
    assertion_operand_c1f43f8d19ba4049ae9a779373261eea_0 = "true"
    driver.implicitly_wait(6)

    # Step - 16 : Scroll to the bottom of the page
    driver.execute_script("window.scrollTo(0, document.body.scrollHeight)")
    time.sleep(1)
    driver.implicitly_wait(6)

    # Step - 17 : Query 'Retired' text visibility
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 18 : set the value of variable 'assertion_operand_34d583a111704627b5ae12247fec9744_0' to true
    assertion_operand_34d583a111704627b5ae12247fec9744_0 = "true"
    driver.implicitly_wait(6)

    # Step - 19 : Assert 'Retired' text is visible on viewport
    assertion_operand_34d583a111704627b5ae12247fec9744_0 = "true"
