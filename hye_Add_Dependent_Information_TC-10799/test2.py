...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_183faaa0d8a049509c7180a3939fe887_0' to true
    assertion_operand_183faaa0d8a049509c7180a3939fe887_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 11 : Click on 'Dependents' tab in the left side menu under Emergency Contacts
    ...
    # Step - 13 : Click on Add button in Assigned Dependents section
    ...
    # Step - 16 : set the value of variable 'assertion_operand_ff639d5fb8f04eeaa2c2b6632fd35534_0' to true
    assertion_operand_ff639d5fb8f04eeaa2c2b6632fd35534_0 = "true"
    driver.implicitly_wait(6)

    # Step - 17 : Assert 'Name' is visible on screen
    assertion_operand_ff639d5fb8f04eeaa2c2b6632fd35534_0 = "true"
    driver.implicitly_wait(6)

    # Step - 18 : Query 'Relationship' text visibility
    ...
    # Step - 19 : set the value of variable 'assertion_operand_3347248915b64cebb3aa178c26fb5658_0' to true
    assertion_operand_3347248915b64cebb3aa178c26fb5658_0 = "true"
    driver.implicitly_wait(6)

    # Step - 20 : Assert 'Relationship' text is visible
    assertion_operand_3347248915b64cebb3aa178c26fb5658_0 = "true"
    driver.implicitly_wait(6)

    # Step - 21 : Query 'Date of Birth' visibility
    element_locators = ["//div[@id='app']/div[1]/div[2]/div[2]/div[1]/div[1]/div[1]/div[2]/div[1]/form[1]/div[2]/div[1]/div[1]/div[1]/div[1]/label[1]", '#app > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(1) > form:nth-child(3) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > label:nth-child(1)', "//label[text()='Date of Birth']", "//label[contains(text(),'Date of Birth')]"]
    element = get_element(driver,element_locators)

    'This Instruction Is Carried Out By The Vision Model'
    driver.implicitly_wait(6)

    # Step - 22 : set the value of variable 'assertion_operand_adf1901d767c48b4b6d2ca1fa52565e6_0' to true
    assertion_operand_adf1901d767c48b4b6d2ca1fa52565e6_0 = "true"
    driver.implicitly_wait(6)

    # Step - 23 : Assert 'Date of Birth' is visible
    assertion_operand_adf1901d767c48b4b6d2ca1fa52565e6_0 = "true"
    driver.implicitly_wait(6)

    # Step - 24 : Query 'Save' text visibility
    ...
    # Step - 25 : set the value of variable 'assertion_operand_c1a7a176216641be92a9bafbd6a8c54b_0' to true
    assertion_operand_c1a7a176216641be92a9bafbd6a8c54b_0 = "true"
    driver.implicitly_wait(6)

    # Step - 26 : Assert 'Save' text is visible
    assertion_operand_c1a7a176216641be92a9bafbd6a8c54b_0 = "true"
    driver.implicitly_wait(6)

    # Step - 27 : Query 'Cancel' text visibility
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 28 : set the value of variable 'assertion_operand_1d354c570e9043f38c10f7e43ffb397e_0' to true
    assertion_operand_1d354c570e9043f38c10f7e43ffb397e_0 = "true"
    driver.implicitly_wait(6)

    # Step - 29 : Assert 'Cancel' text is visible
    assertion_operand_1d354c570e9043f38c10f7e43ffb397e_0 = "true"
    driver.implicitly_wait(6)

    # Step - 30 : Click 'Save' button
    element_locators = ['[type="submit"]', '.oxd-button--secondary', '.oxd-button--medium.oxd-button--secondary', '.oxd-button--ghost + button', "//button[starts-with(@type,'submi')]", "//button[contains(@class,'oxd-button--secondary')]", "//button[contains(@type,'submit')]", "//button[contains(@class,'oxd-button--medium') and contains(@class,'oxd-button--secondary')]"]
    element = get_element(driver,element_locators)
    ...
    # Step - 31 : Query 'Required' text visibility
    element_locators = ["//div[@id='app']/div[1]/div[2]/div[2]/div[1]/div[1]/div[1]/div[2]/div[1]/form[1]/div[1]/div[1]/div[1]/div[1]/span[1]", '#app > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(1) > form:nth-child(3) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > span:nth-child(3)']
    element = get_element(driver,element_locators)

    'This Instruction Is Carried Out By The Vision Model'
    driver.implicitly_wait(6)

    # Step - 32 : set the value of variable 'assertion_operand_99508e2f540048249b1ae6bd8721b6d7_0' to true
    assertion_operand_99508e2f540048249b1ae6bd8721b6d7_0 = "true"
    driver.implicitly_wait(6)

    # Step - 33 : Assert 'Required' text is visible
    assertion_operand_99508e2f540048249b1ae6bd8721b6d7_0 = "true"
    driver.implicitly_wait(6)
