...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_3a4508f5a0a343428da981725ac52b20_0' to true
    assertion_operand_3a4508f5a0a343428da981725ac52b20_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 9 : Click on 'Directory' menu item in left sidebar
    element_locators = ["//nav[@role='navigation' and @aria-label='Sidepanel']/div[2]/ul[1]/li[9]/a[1]/span[1]", "//span[text()='Directory']", '[aria-label="Sidepanel"] > div:nth-child(2) > ul:nth-child(2) > li:nth-child(9) > a:nth-child(1) > span:nth-child(2)']
    element = get_element(driver,element_locators)
    ...
    # Step - 12 : set the value of variable 'assertion_operand_ea58b3dcea62468692a73e864134c8ac_0' to viewDirectory
    assertion_operand_ea58b3dcea62468692a73e864134c8ac_0 = "viewDirectory"
    driver.implicitly_wait(6)

    # Step - 13 : Assert current URL contains 'viewDirectory'
    assertion_operand_ea58b3dcea62468692a73e864134c8ac_0 = "viewDirectory"
    driver.implicitly_wait(6)

    # Step - 14 : Query 'Reset' button visibility
    ...
    # Step - 15 : set the value of variable 'assertion_operand_2531644a89174f0cbe69cc0eaba57ee3_0' to true
    assertion_operand_2531644a89174f0cbe69cc0eaba57ee3_0 = "true"
    driver.implicitly_wait(6)

    # Step - 16 : Assert 'Reset' button is visible
    assertion_operand_2531644a89174f0cbe69cc0eaba57ee3_0 = "true"
    driver.implicitly_wait(6)

    # Step - 17 : Query 'Search' button visibility
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 18 : set the value of variable 'assertion_operand_3098aea16b0e489ea525e33fbfd71eb4_0' to true
    assertion_operand_3098aea16b0e489ea525e33fbfd71eb4_0 = "true"
    driver.implicitly_wait(6)

    # Step - 19 : Assert 'Search' button is visible
    assertion_operand_3098aea16b0e489ea525e33fbfd71eb4_0 = "true"
    driver.implicitly_wait(6)

    # Step - 20 : Click on employee name search input with placeholder 'Type for hints...'
    ...
    # Step - 21 : Type in employee name input field with placeholder 'Type for hints...' 'test'
    element_locators = ['[placeholder="Type for hints..."]', '.oxd-autocomplete-text-input--focus > input', '.oxd-autocomplete-text-input--before + input', 'input:has(+ .oxd-autocomplete-text-input--after)', "//input[starts-with(@placeholder,'Type ')]", "//div[contains(@class,'oxd-autocomplete-text-input--focus')]/input[1]", "//input[contains(@placeholder,'Type for hints...')]", "//div[contains(@class,'oxd-autocomplete-text-input--focus')]/input[1]"]
    element = get_element(driver,element_locators)
    ...
    # Step - 23 : Query 'Invalid' text visibility
    ...
    # Step - 24 : set the value of variable 'assertion_operand_b2b19eb1be074e15a53be123a2944a9a_0' to true
    assertion_operand_b2b19eb1be074e15a53be123a2944a9a_0 = "true"
    driver.implicitly_wait(6)

    # Step - 25 : Assert 'Invalid' text is visible
    assertion_operand_b2b19eb1be074e15a53be123a2944a9a_0 = "true"
    driver.implicitly_wait(6)

    # Step - 26 : Click on the Search button in directory filter section
    ...
    # Step - 27 : Click on the job title dropdown arrow in directory filter
    ...
    # Step - 28 : Click on the location dropdown arrow in directory filter
    element_locators = ['.oxd-select-text--focus > div:nth-child(2) > i:nth-child(1)', '.oxd-select-text--focus > div:nth-child(2) > i:nth-child(1)', "//div[contains(@class,'oxd-select-text--focus')]/div[2]/i[1]", "//div[contains(@class,'oxd-select-text--focus')]/div[2]/i[1]"]
    element = get_element(driver,element_locators)
    ...
    # Step - 29 : Click on the Reset button in directory search form
    element_locators = ['[type="reset"]', '.oxd-button--ghost', '.oxd-button--medium.oxd-button--ghost', 'button:has(+ .oxd-button--secondary)', "//button[starts-with(@type,'reset')]", "//button[contains(@class,'oxd-button--ghost')]", "//button[contains(@type,'reset')]", "//button[contains(@class,'oxd-button--medium') and contains(@class,'oxd-button--ghost')]"]
    element = get_element(driver,element_locators)
