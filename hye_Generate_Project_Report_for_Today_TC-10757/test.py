...
class FirstSampleTest(unittest.TestCase):
    ...
    def test_demo_site(self):
        ...
        try:
            ...
            # Click 'Project Date Range' from dropdown
            lambda_hooks(driver, "Click 'Project Date Range' from dropdown")
            ...
            # set the value of variable 'assertion_operand_f10fcebc75ca43438bf81a21f8a41969_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_f10fcebc75ca43438bf81a21f8a41969_0' to true")
            ...
            to_date_text_visible = vision_query(driver = driver, operation_index = str(12))
            ...
            # set the value of variable 'assertion_operand_71ae523b2d7f4a2bb6f4a37b97a2f862_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_71ae523b2d7f4a2bb6f4a37b97a2f862_0' to true")
