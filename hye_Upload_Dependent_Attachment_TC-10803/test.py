...
class FirstSampleTest(unittest.TestCase):
    ...
    def test_demo_site(self):
        ...
        try:
            ...
            # Click on the plus icon next to Attachments label
            lambda_hooks(driver, "Click on the plus icon next to Attachments label")
            ...
            # set the value of variable 'assertion_operand_4ef008ba62f84ee9b0024ed722d513fd_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_4ef008ba62f84ee9b0024ed722d513fd_0' to true")
            ...
            # set the value of variable 'assertion_operand_2142f34d6c3b49e9846e0af642187f6f_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_2142f34d6c3b49e9846e0af642187f6f_0' to true")
            ...
            Comment_visible = vision_query(driver = driver, operation_index = str(11))
            ...
            # set the value of variable 'assertion_operand_182f725a70cd49d083ddca02abf1b5d1_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_182f725a70cd49d083ddca02abf1b5d1_0' to true")
            ...
            Cancel_visible = vision_query(driver = driver, operation_index = str(14))
            ...
            # set the value of variable 'assertion_operand_e3a99978f6ff48578ad443caf2277d9c_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_e3a99978f6ff48578ad443caf2277d9c_0' to true")
            ...
            Save_visible = vision_query(driver = driver, operation_index = str(17))
            ...
            # set the value of variable 'assertion_operand_73f97e32e20443e486345a147395b253_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_73f97e32e20443e486345a147395b253_0' to true")
            ...
            Required_visible = vision_query(driver = driver, operation_index = str(21))
            ...
            # set the value of variable 'assertion_operand_fb80be0e939e4699a155fc2dc3106088_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_fb80be0e939e4699a155fc2dc3106088_0' to true")
