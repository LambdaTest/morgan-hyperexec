...
class FirstSampleTest(unittest.TestCase):
    ...
    def test_demo_site(self):
        ...
        try:
            ...
            # set the value of variable 'assertion_operand_38dc621ac2da4ddd8a63abb068ba43ba_0' to Nationality
            lambda_hooks(driver, "set the value of variable 'assertion_operand_38dc621ac2da4ddd8a63abb068ba43ba_0' to Nationality")
            ...
            # Click 'Edit' icon for 'American'
            lambda_hooks(driver, "Click 'Edit' icon for 'American'")
            ui_action(driver = driver, operation_index = str(6))

            # clear the 'name' field
            lambda_hooks(driver, "clear the 'name' field")
            ...
            required_visible = vision_query(driver = driver, operation_index = str(9))
            ...
            # set the value of variable 'assertion_operand_54253ca321d34fc9b1f0dd92bdb6e598_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_54253ca321d34fc9b1f0dd92bdb6e598_0' to true")
