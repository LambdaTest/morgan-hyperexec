...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_454b715d4a4648c3a922a6d750163f00_0' to true
    assertion_operand_454b715d4a4648c3a922a6d750163f00_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 9 : Click on 'Performance' menu item in the left sidebar
    ...
    # Step - 13 : Click on employee name input field with placeholder 'Type for hints...'
    ...
    # Step - 14 : Type in employee name input field with placeholder 'Type for hints...' 'ayush'
    element_locators = ['[placeholder="Type for hints..."]', '.oxd-autocomplete-text-input--focus > input', '.oxd-autocomplete-text-input--before + input', 'input:has(+ .oxd-autocomplete-text-input--after)', "//input[starts-with(@placeholder,'Type ')]", "//div[contains(@class,'oxd-autocomplete-text-input--focus')]/input[1]", "//input[contains(@placeholder,'Type for hints...')]", "//div[contains(@class,'oxd-autocomplete-text-input--focus')]/input[1]"]
    element = get_element(driver,element_locators)
    ...
    # Step - 16 : Click on the include dropdown arrow in employee performance trackers section
    ...
    # Step - 17 : Query visibility of text 'Current and Past Employees'
    ...
    # Step - 18 : set the value of variable 'assertion_operand_41b14e369f4e4e4b88d4e3eed3d4cf78_0' to true
    assertion_operand_41b14e369f4e4e4b88d4e3eed3d4cf78_0 = "true"
    driver.implicitly_wait(6)

    # Step - 19 : Assert text 'Current and Past Employees' is visible
    assertion_operand_41b14e369f4e4e4b88d4e3eed3d4cf78_0 = "true"
    driver.implicitly_wait(6)

    # Step - 20 : Query 'Past Employees Only' visibility
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 21 : set the value of variable 'assertion_operand_7bb759094ff44b389eae40c6a9ad087f_0' to true
    assertion_operand_7bb759094ff44b389eae40c6a9ad087f_0 = "true"
    driver.implicitly_wait(6)

    # Step - 22 : Assert 'Past Employees Only' is visible
    assertion_operand_7bb759094ff44b389eae40c6a9ad087f_0 = "true"
    driver.implicitly_wait(6)

    # Step - 23 : Click on the 'Search' button in Employee Performance Trackers section
    ...
    # Step - 24 : wait 3 seconds
    time.sleep(int(3))
    driver.implicitly_wait(6)

    # Step - 25 : Query 'No Records Found' visibility
    element_locators = ["//div[@id='app']/div[1]/div[2]/div[2]/div[1]/div[2]/div[1]", '#app > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(3) > div:nth-child(1)']
    element = get_element(driver,element_locators)

    'This Instruction Is Carried Out By The Vision Model'
    driver.implicitly_wait(6)

    # Step - 26 : set the value of variable 'assertion_operand_2ab4318cce184c839a3df47f201dddca_0' to true
    assertion_operand_2ab4318cce184c839a3df47f201dddca_0 = "true"
    driver.implicitly_wait(6)

    # Step - 27 : Assert 'No Records Found' text is visible
    assertion_operand_2ab4318cce184c839a3df47f201dddca_0 = "true"
