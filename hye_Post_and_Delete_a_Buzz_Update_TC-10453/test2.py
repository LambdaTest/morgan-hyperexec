...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_d7c5e8624b3747b39d7260428831a1b3_0' to true
    assertion_operand_d7c5e8624b3747b39d7260428831a1b3_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 11 : Type in What's on your mind? input textarea 'test'
    element_locators = ['[placeholder="What\'s on your mind?"]', '.oxd-buzz-post--focus > textarea', '.oxd-buzz-post--focus > textarea:nth-child(1)', '.oxd-buzz-post--focus > textarea:nth-child(1)', "//div[contains(@class,'oxd-buzz-post--focus')]/textarea[1]", "//div[contains(@class,'oxd-buzz-post--focus')]/textarea[1]"]
    element = get_element(driver,element_locators)
    ...
    # Step - 13 : Click on the heart icon below post by Pushpa Raj
    element_locators = ['#heart-svg', '#app > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(4) > div:nth-child(1) > div:nth-child(1) > div:nth-child(3) > div:nth-child(1) > div:nth-child(1) > svg:nth-child(1)', "//div[@id='app']/div[1]/div[2]/div[2]/div[1]/div[1]/div[1]/div[3]/div[1]/div[1]/div[3]/div[1]/div[1]/*[local-name()='svg']"]
    element = get_element(driver,element_locators)
    ...
    # Step - 14 : Query '1 Like' visibility
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 15 : set the value of variable 'assertion_operand_46c43b8efe954d3c888981d96c019442_0' to true
    assertion_operand_46c43b8efe954d3c888981d96c019442_0 = "true"
    driver.implicitly_wait(6)

    # Step - 16 : Assert '1 Like' is visible
    assertion_operand_46c43b8efe954d3c888981d96c019442_0 = "true"
    driver.implicitly_wait(6)

    # Step - 17 : Click on the red heart icon below post by Pushpa Raj
    element_locators = ['#heart-svg', '#app > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(4) > div:nth-child(1) > div:nth-child(1) > div:nth-child(3) > div:nth-child(1) > div:nth-child(1) > svg:nth-child(1)', "//div[@id='app']/div[1]/div[2]/div[2]/div[1]/div[1]/div[1]/div[3]/div[1]/div[1]/div[3]/div[1]/div[1]/*[local-name()='svg']"]
    element = get_element(driver,element_locators)
    ...
    # Step - 18 : Query '0 Likes' visibility
    element_locators = ['.orangehrm-buzz-stats-like-icon + p', "//div[@id='app']/div[1]/div[2]/div[2]/div[1]/div[1]/div[1]/div[3]/div[1]/div[1]/div[3]/div[2]/div[1]/p[1]", '#app > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(4) > div:nth-child(1) > div:nth-child(1) > div:nth-child(3) > div:nth-child(2) > div:nth-child(1) > p:nth-child(2)', "//p[text()='0 Likes']"]
    element = get_element(driver,element_locators)

    'This Instruction Is Carried Out By The Vision Model'
    driver.implicitly_wait(6)

    # Step - 19 : set the value of variable 'assertion_operand_be23fbe7f4e04926970472deb6947085_0' to true
    assertion_operand_be23fbe7f4e04926970472deb6947085_0 = "true"
    driver.implicitly_wait(6)

    # Step - 20 : Assert '0 Likes' is visible on screen
    assertion_operand_be23fbe7f4e04926970472deb6947085_0 = "true"
    driver.implicitly_wait(6)
