...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_da861cd4cdcc4a099ea1ffc7c2439705_0' to true
    assertion_operand_da861cd4cdcc4a099ea1ffc7c2439705_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 11 : Click on 'Expense Types' menu item in the left side vertical menu
    ...
    # Step - 13 : Type in Name input field with placeholder 'Type for hints...' 'Ayush'
    element_locators = ['[placeholder="Type for hints..."]', '.oxd-autocomplete-text-input--focus > input', '.oxd-autocomplete-text-input--before + input', 'input:has(+ .oxd-autocomplete-text-input--after)', "//input[starts-with(@placeholder,'Type ')]", "//div[contains(@class,'oxd-autocomplete-text-input--focus')]/input[1]", "//input[contains(@placeholder,'Type for hints...')]", "//div[contains(@class,'oxd-autocomplete-text-input--focus')]/input[1]"]
    element = get_element(driver,element_locators)
    ...
    # Step - 14 : Query visibility of text 'Ayush'
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 15 : Query visibility of text 'No Records Found' below 'Ayush'
    element_locators = ['[role="option"]', '.--positon-bottom > div', '.--positon-bottom > div:nth-child(1)', "//div[text()='No Records Found']", '[role="listbox"] > div', "//div[starts-with(@role,'optio')]", "//div[contains(@class,'--positon-bottom')]/div[1]", "//div[contains(@role,'option')]"]
    element = get_element(driver,element_locators)

    'This Instruction Is Carried Out By The Vision Model'
    driver.implicitly_wait(6)

    # Step - 16 : set the value of variable 'assertion_operand_d9eaedb152024dc0b662daa1cc0f7ec0_0' to true
    assertion_operand_d9eaedb152024dc0b662daa1cc0f7ec0_0 = "true"
    driver.implicitly_wait(6)

    # Step - 17 : Assert 'No Records Found' is visible below 'Ayush'
    assertion_operand_d9eaedb152024dc0b662daa1cc0f7ec0_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 19 : set the value of variable 'assertion_operand_aff149081c6d4a9881a3b00301701369_0' to true
    assertion_operand_aff149081c6d4a9881a3b00301701369_0 = "true"
    driver.implicitly_wait(6)

    # Step - 20 : Assert 'Name' text is visible
    assertion_operand_aff149081c6d4a9881a3b00301701369_0 = "true"
    driver.implicitly_wait(6)

    # Step - 21 : Query 'Status' text visibility
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 22 : set the value of variable 'assertion_operand_5e23f3abeed6491882728d8d21597587_0' to true
    assertion_operand_5e23f3abeed6491882728d8d21597587_0 = "true"
    driver.implicitly_wait(6)

    # Step - 23 : Assert 'Status' text is visible
    assertion_operand_5e23f3abeed6491882728d8d21597587_0 = "true"
    driver.implicitly_wait(6)

    # Step - 24 : Query 'Actions' text visibility
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 25 : set the value of variable 'assertion_operand_f4c6ac06a0d948f1a1de945d86953bcc_0' to true
    assertion_operand_f4c6ac06a0d948f1a1de945d86953bcc_0 = "true"
    driver.implicitly_wait(6)

    # Step - 26 : Assert 'Actions' text is visible
    assertion_operand_f4c6ac06a0d948f1a1de945d86953bcc_0 = "true"
