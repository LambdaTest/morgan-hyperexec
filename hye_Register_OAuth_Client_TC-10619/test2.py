...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_ef39bec604fd4dbe98a1dea9ecf56a25_0' to true
    assertion_operand_ef39bec604fd4dbe98a1dea9ecf56a25_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 15 : Query count of 'required' text
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 18 : Query count of elements with text 'required'
    element_locators = ['']
    element = get_element(driver,element_locators)
