...
class FirstSampleTest(unittest.TestCase):
    ...
    def test_demo_site(self):
        ...
        try:
            ...
            # Query count of 'required' text
            lambda_hooks(driver, "Query count of 'required' text")
            required_count = vision_query(driver = driver, operation_index = str(6))
            if isinstance(required_count, dict):
                required_count = required_count.get("vision_query")
            user_variables["required_count"] =  required_count
            ...
            # Query count of elements with text 'required'
            lambda_hooks(driver, "Query count of elements with text 'required'")
            required_count = vision_query(driver = driver, operation_index = str(9))
            if isinstance(required_count, dict):
                required_count = required_count.get("vision_query")
            user_variables["required_count"] =  required_count
            print("required_count:", required_count)
