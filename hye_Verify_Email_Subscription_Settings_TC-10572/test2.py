...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_cc6984dedf294c8ebf4d6a06fb9f69fa_0' to true
    assertion_operand_cc6984dedf294c8ebf4d6a06fb9f69fa_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 12 : Click 'Email Subscription' dropdown
    element_locators = ["//nav[@role='navigation' and @aria-label='Topbar Menu']/ul[1]/li[7]/ul[1]/li[2]/a[1]", "//a[text()='Email Subscriptions']", "//a[contains(text(),'Email Subscriptions')]", '[aria-label="Topbar Menu"] > ul:nth-child(1) > li:nth-child(7) > ul:nth-child(2) > li:nth-child(2) > a:nth-child(1)']
    element = get_element(driver,element_locators)
    ...
    # Step - 13 : Query if '(5) Records Found' text is visible
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 14 : set the value of variable 'assertion_operand_a446414e3c3f406bb6afea3919d8a532_0' to true
    assertion_operand_a446414e3c3f406bb6afea3919d8a532_0 = "true"
    driver.implicitly_wait(6)

    # Step - 15 : Assert '(5) Records Found' text is visible
    assertion_operand_a446414e3c3f406bb6afea3919d8a532_0 = "true"
    driver.implicitly_wait(6)

    # Step - 16 : Query 'Notification Type' visibility
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 17 : set the value of variable 'assertion_operand_c8d830ed4c724ce5b656d675f7e800e5_0' to true
    assertion_operand_c8d830ed4c724ce5b656d675f7e800e5_0 = "true"
    driver.implicitly_wait(6)

    # Step - 18 : Assert 'Notification Type' is displayed
    assertion_operand_c8d830ed4c724ce5b656d675f7e800e5_0 = "true"
    driver.implicitly_wait(6)

    # Step - 19 : Query 'Leave Applications' text visibility
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 20 : set the value of variable 'assertion_operand_6dd0a93fae3c40a5bcc07650eeafd9da_0' to true
    assertion_operand_6dd0a93fae3c40a5bcc07650eeafd9da_0 = "true"
    driver.implicitly_wait(6)

    # Step - 21 : Assert 'Leave Applications' text is displayed
    assertion_operand_6dd0a93fae3c40a5bcc07650eeafd9da_0 = "true"
