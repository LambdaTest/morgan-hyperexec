...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_77d0f8fa4edc4cc9970e0c8c027a31b2_0' to true
    assertion_operand_77d0f8fa4edc4cc9970e0c8c027a31b2_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 9 : Click on user dropdown with name Pushpa Raj in top right corner
    ...
    # Step - 10 : Query 'About' text visibility
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 11 : set the value of variable 'assertion_operand_5a25bf8fba864ce2ac46dafc9a083b52_0' to true
    assertion_operand_5a25bf8fba864ce2ac46dafc9a083b52_0 = "true"
    driver.implicitly_wait(6)

    # Step - 12 : Assert 'About' text is visible on viewport
    assertion_operand_5a25bf8fba864ce2ac46dafc9a083b52_0 = "true"
    driver.implicitly_wait(6)

    # Step - 13 : Query 'Support' text visibility
    ...
    # Step - 14 : set the value of variable 'assertion_operand_95d56604c8bd4989a7d5e84d35e2ca8c_0' to true
    assertion_operand_95d56604c8bd4989a7d5e84d35e2ca8c_0 = "true"
    driver.implicitly_wait(6)

    # Step - 15 : Assert 'Support' text is visible
    assertion_operand_95d56604c8bd4989a7d5e84d35e2ca8c_0 = "true"
    driver.implicitly_wait(6)

    # Step - 16 : Query 'Change Password' text visibility
    ...
    # Step - 17 : set the value of variable 'assertion_operand_6ea6ebcd84b74314a6f25fb51ea1c2b4_0' to true
    assertion_operand_6ea6ebcd84b74314a6f25fb51ea1c2b4_0 = "true"
    driver.implicitly_wait(6)

    # Step - 18 : Assert 'Change Password' text is visible
    assertion_operand_6ea6ebcd84b74314a6f25fb51ea1c2b4_0 = "true"
    driver.implicitly_wait(6)

    # Step - 19 : Query 'Logout' text visibility
    ...
    # Step - 20 : set the value of variable 'assertion_operand_f03b3abaea334ba29cba8862dee4d53e_0' to true
    assertion_operand_f03b3abaea334ba29cba8862dee4d53e_0 = "true"
    driver.implicitly_wait(6)

    # Step - 21 : Assert 'Logout' text is visible on the viewport
    assertion_operand_f03b3abaea334ba29cba8862dee4d53e_0 = "true"
