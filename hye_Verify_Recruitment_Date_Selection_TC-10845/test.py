...
class FirstSampleTest(unittest.TestCase):
    ...
    def test_demo_site(self):
        ...
        try:
            ...
            to_date_after_from_date_visible = vision_query(driver = driver, operation_index = str(6))
            ...
            # set the value of variable 'assertion_operand_153002b3be154ecda46121625bb42a78_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_153002b3be154ecda46121625bb42a78_0' to true")
