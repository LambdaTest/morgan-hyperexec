...
class FirstSampleTest(unittest.TestCase):
    ...
    def test_demo_site(self):
        ...
        try:
            ...
            # type 'abc' in name field
            lambda_hooks(driver, f"type {UIActions.operations_meta_data['5']['value']}")
            ui_action(driver = driver, operation_index = str(5))

            # Click 'country dropdown'
            lambda_hooks(driver, "Click 'country dropdown'")
            ui_action(driver = driver, operation_index = str(6))

            # Click 'afganistan' option in dropdown
            lambda_hooks(driver, "Click 'afganistan' option in dropdown")
            ui_action(driver = driver, operation_index = str(7))

            # Query if 'abc' is displayed on the viewport
            lambda_hooks(driver, "Query if 'abc' is displayed on the viewport")
            ...
            # set the value of variable 'assertion_operand_9ac88cc90d714410a2f718867e2910f5_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_9ac88cc90d714410a2f718867e2910f5_0' to true")
            ...
            # Query if 'afghanistan' is displayed on the viewport
            lambda_hooks(driver, "Query if 'afghanistan' is displayed on the viewport")
            afghanistan_visible = vision_query(driver = driver, operation_index = str(11))
            ...
            # set the value of variable 'assertion_operand_8275a000b25642eda87e4a2a874ea5fb_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_8275a000b25642eda87e4a2a874ea5fb_0' to true")
