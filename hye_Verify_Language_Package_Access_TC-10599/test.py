...
class FirstSampleTest(unittest.TestCase):
    ...
    def test_demo_site(self):
        ...
        try:
            ...
            # set the value of variable 'assertion_operand_3e878116fa074eba8537732e66e9d491_0' to languagePackage
            lambda_hooks(driver, "set the value of variable 'assertion_operand_3e878116fa074eba8537732e66e9d491_0' to languagePackage")
            ...
            # Query if '(8) Record Found' text is visible
            lambda_hooks(driver, "Query if '(8) Record Found' text is visible")
            ...
            # set the value of variable 'assertion_operand_5b5475168f7b41bc9a24b063d522be5c_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_5b5475168f7b41bc9a24b063d522be5c_0' to true")
