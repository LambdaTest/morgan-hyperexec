...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_b18117fe87c74621b55af401013375e9_0' to true
    assertion_operand_b18117fe87c74621b55af401013375e9_0 = "true"
    driver.implicitly_wait(6)
    ...
    element_locators = ['.oxd-input-field-error-message', '.oxd-text--span.oxd-input-field-error-message', "//div[@id='app']/div[1]/div[2]/div[2]/div[1]/div[1]/form[1]/div[1]/div[1]/div[1]/div[1]/span[1]", '#app > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > form:nth-child(3) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > span:nth-child(3)', "//span[text()='Required']", "//span[contains(@class,'oxd-input-field-error-message')]", "//span[contains(@class,'oxd-text--span') and contains(@class,'oxd-input-field-error-message')]"]
    element = get_element(driver,element_locators)

    'This Instruction Is Carried Out By The Vision Model'
    driver.implicitly_wait(6)

    # Step - 17 : set the value of variable 'assertion_operand_14a45aca354447b2bf8c9f5039957268_0' to true
    assertion_operand_14a45aca354447b2bf8c9f5039957268_0 = "true"
    driver.implicitly_wait(6)

    # Step - 18 : Assert 'Required' text is visible on the viewport
    assertion_operand_14a45aca354447b2bf8c9f5039957268_0 = "true"
    driver.implicitly_wait(6)

    # Step - 19 : type 'abc' in Report name
    element_locators = ['[placeholder="Type here ..."]', '.oxd-input--error', "//div[@id='app']/div[1]/div[2]/div[2]/div[1]/div[1]/form[1]/div[1]/div[1]/div[1]/div[1]/div[2]/input[1]", '#app > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > form:nth-child(3) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > input:nth-child(1)', "//input[starts-with(@placeholder,'Type ')]", "//input[contains(@class,'oxd-input--error')]", "//input[contains(@placeholder,'Type here ...')]"]
    element = get_element(driver,element_locators)
    ...
    # Step - 21 : Query 'PIM Sample Report' text visibility
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 22 : set the value of variable 'assertion_operand_2614f70682c344f9972b6f1741c8a881_0' to true
    assertion_operand_2614f70682c344f9972b6f1741c8a881_0 = "true"
    driver.implicitly_wait(6)

    # Step - 23 : Assert 'PIM Sample Report' text is visible
    assertion_operand_2614f70682c344f9972b6f1741c8a881_0 = "true"
