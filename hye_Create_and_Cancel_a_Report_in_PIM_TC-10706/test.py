...
class FirstSampleTest(unittest.TestCase):
    ...
    def test_demo_site(self):
        ...
        try:
            ...
            # Click 'Reports'
            lambda_hooks(driver, "Click 'Reports'")
            ...
            # set the value of variable 'assertion_operand_14a45aca354447b2bf8c9f5039957268_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_14a45aca354447b2bf8c9f5039957268_0' to true")
            ...
            # type 'abc' in Report name
            lambda_hooks(driver, f"type {UIActions.operations_meta_data['10']['value']}")
            ui_action(driver = driver, operation_index = str(10))

            # Click 'Cancel'
            lambda_hooks(driver, "Click 'Cancel'")
            ui_action(driver = driver, operation_index = str(11))

            # Query 'PIM Sample Report' text visibility
            lambda_hooks(driver, "Query 'PIM Sample Report' text visibility")
            PIM_Sample_Report_visible = vision_query(driver = driver, operation_index = str(12))
            if isinstance(PIM_Sample_Report_visible, dict):
                PIM_Sample_Report_visible = PIM_Sample_Report_visible.get("vision_query")
            user_variables["PIM_Sample_Report_visible"] =  PIM_Sample_Report_visible
            print("PIM_Sample_Report_visible:", PIM_Sample_Report_visible)

            # set the value of variable 'assertion_operand_2614f70682c344f9972b6f1741c8a881_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_2614f70682c344f9972b6f1741c8a881_0' to true")
