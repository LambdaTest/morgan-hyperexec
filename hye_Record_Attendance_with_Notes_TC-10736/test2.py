...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_3a8974773cb741b183245dab04ae43e2_0' to true
    assertion_operand_3a8974773cb741b183245dab04ae43e2_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 15 : type 'testing' in notes
    element_locators = ['[placeholder="Type here"]', '.oxd-textarea--resize-vertical', "//div[@id='app']/div[1]/div[2]/div[2]/div[1]/div[1]/div[1]/form[1]/div[2]/div[1]/div[1]/div[1]/div[2]/textarea[1]", '#app > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(3) > form:nth-child(1) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > textarea:nth-child(1)', "//textarea[starts-with(@placeholder,'Type ')]", "//textarea[contains(@placeholder,'Type here')]", "//textarea[contains(@class,'oxd-textarea--resize-vertical')]"]
    element = get_element(driver,element_locators)
