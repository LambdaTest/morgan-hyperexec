...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_ffe73c690ff849418657f7bef1718a72_0' to true
    assertion_operand_ffe73c690ff849418657f7bef1718a72_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 14 : Query 'Required' text visibility
    element_locators = ['p:has(+ .oxd-button--medium)', 'p:has(+ .oxd-button--secondary)', 'p:has(+ .oxd-button--medium.oxd-button--secondary)', "//div[@id='app']/div[1]/div[2]/div[2]/div[1]/div[1]/div[2]/form[1]/div[4]/p[1]", 'p:has(+ [type="submit"])']
    element = get_element(driver,element_locators)

    'This Instruction Is Carried Out By The Vision Model'
    driver.implicitly_wait(6)

    # Step - 15 : set the value of variable 'assertion_operand_ff01895de1c642098d8b3e8bcd0af43e_0' to true
    assertion_operand_ff01895de1c642098d8b3e8bcd0af43e_0 = "true"
    driver.implicitly_wait(6)

    # Step - 16 : Assert 'Required' text is visible on viewport
    assertion_operand_ff01895de1c642098d8b3e8bcd0af43e_0 = "true"
    driver.implicitly_wait(6)

    # Step - 17 : type 'pushpa' in employee name section
    element_locators = ['.oxd-autocomplete-text-input--error > input', '.oxd-autocomplete-text-input--error > input:nth-child(2)', '.oxd-autocomplete-text-input--error > input:nth-child(2)', "//div[contains(@class,'oxd-autocomplete-text-input--error')]/input[1]", "//div[contains(@class,'oxd-autocomplete-text-input--error')]/input[1]"]
    element = get_element(driver,element_locators)
    ...
    # Step - 19 : Click 'pushpa' from the dropdown
    ...
    # Step - 21 : Query 'Pushpa Raj' text visibility
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 22 : set the value of variable 'assertion_operand_98c34a2a5dd44111bd3a677697cf7ff1_0' to true
    assertion_operand_98c34a2a5dd44111bd3a677697cf7ff1_0 = "true"
    driver.implicitly_wait(6)

    # Step - 23 : Assert 'Pushpa Raj' text is visible
    assertion_operand_98c34a2a5dd44111bd3a677697cf7ff1_0 = "true"
