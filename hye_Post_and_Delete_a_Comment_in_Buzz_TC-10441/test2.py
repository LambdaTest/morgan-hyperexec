...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_84e8583701014b018eb12da1be537c7f_0' to true
    assertion_operand_84e8583701014b018eb12da1be537c7f_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 11 : Type in What's on your mind? input textarea 'Feed's comment'
    element_locators = ['[placeholder="What\'s on your mind?"]', '.oxd-buzz-post--focus > textarea', '.oxd-buzz-post--focus > textarea:nth-child(1)', '.oxd-buzz-post--focus > textarea:nth-child(1)', "//div[contains(@class,'oxd-buzz-post--focus')]/textarea[1]", "//div[contains(@class,'oxd-buzz-post--focus')]/textarea[1]"]
    element = get_element(driver,element_locators)
    ...
    driver.execute_script("arguments[0].value = '';", element)
    if element.get_attribute("pattern") and '[0-9]{2}' in element.get_attribute("pattern"):
        for char in 'Feed's comment':
            element.send_keys(char)
    else:
        element.send_keys('Feed's comment')
    driver.implicitly_wait(6)
    ...
    # Step - 13 : Query 'Feed's comment' visibility
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 14 : set the value of variable 'assertion_operand_2f0f33d565334ab187e44988a2c3095e_0' to true
    assertion_operand_2f0f33d565334ab187e44988a2c3095e_0 = "true"
    driver.implicitly_wait(6)

    # Step - 15 : Assert 'Feed's comment' is visible
    assertion_operand_2f0f33d565334ab187e44988a2c3095e_0 = "true"
    driver.implicitly_wait(6)

    # Step - 16 : Click on the three dots menu icon
    ...
    # Step - 17 : Click on 'Delete Post' text button
    ...
    # Step - 18 : Click on 'Yes, Delete' button with trash icon
