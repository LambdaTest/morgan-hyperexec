...
class FirstSampleTest(unittest.TestCase):
    ...
    def test_demo_site(self):
        ...
        try:
            ...
            # type 'test' in report name section
            ...
            invalid_visible = vision_query(driver = driver, operation_index = str(6))
            ...
            # set the value of variable 'assertion_operand_98817bc0b00a4987a0d5826472439c6f_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_98817bc0b00a4987a0d5826472439c6f_0' to true")
