...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_664681c34fcc4d49bc7247e5de182e05_0' to true
    assertion_operand_664681c34fcc4d49bc7247e5de182e05_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 13 : type 'test' in report name section
    ...
    # Step - 15 : Query 'invalid' text visibility
    ...
    # Step - 16 : set the value of variable 'assertion_operand_98817bc0b00a4987a0d5826472439c6f_0' to true
    assertion_operand_98817bc0b00a4987a0d5826472439c6f_0 = "true"
    driver.implicitly_wait(6)

    # Step - 17 : Assert 'invalid' text is visible on the viewport
    assertion_operand_98817bc0b00a4987a0d5826472439c6f_0 = "true"
    driver.implicitly_wait(6)

    # Step - 18 : Click 'Reset' button
