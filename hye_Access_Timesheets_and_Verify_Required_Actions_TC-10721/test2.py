...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_4815927ed2d5480984f89e5fafc9bf17_0' to true
    assertion_operand_4815927ed2d5480984f89e5fafc9bf17_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 12 : Query 'Required' text visibility
    ...
    # Step - 13 : set the value of variable 'assertion_operand_321ceb308de3445e959d091288088702_0' to true
    assertion_operand_321ceb308de3445e959d091288088702_0 = "true"
    driver.implicitly_wait(6)

    # Step - 14 : Assert 'Required' text is visible on the viewport
    assertion_operand_321ceb308de3445e959d091288088702_0 = "true"
    driver.implicitly_wait(6)

    # Step - 15 : Query if 'Timesheets Pending Action' text is visible
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 16 : set the value of variable 'assertion_operand_dc9ea73596a84c14b7df8c42961562c9_0' to true
    assertion_operand_dc9ea73596a84c14b7df8c42961562c9_0 = "true"
    driver.implicitly_wait(6)

    # Step - 17 : Assert 'Timesheets Pending Action' text is visible
    assertion_operand_dc9ea73596a84c14b7df8c42961562c9_0 = "true"
