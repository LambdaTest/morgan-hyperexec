...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_d8a6162ce81b426aa0b87e19189b8ad0_0' to true
    assertion_operand_d8a6162ce81b426aa0b87e19189b8ad0_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 14 : set the value of variable 'assertion_operand_951d42d06ab84a5b9d2a16e33936cb68_0' to viewMyTimesheet
    assertion_operand_951d42d06ab84a5b9d2a16e33936cb68_0 = "viewMyTimesheet"
    driver.implicitly_wait(6)

    # Step - 15 : Assert '{{url}}' contains 'viewMyTimesheet'
    assertion_operand_951d42d06ab84a5b9d2a16e33936cb68_0 = "viewMyTimesheet"
    driver.implicitly_wait(6)

    # Step - 16 : Query if 'No Records found' text is visible
    element_locators = ['.orangehrm-timesheet-table-body-row', "//div[@id='app']/div[1]/div[2]/div[2]/div[1]/form[1]/div[2]/table[1]/tbody[1]/tr[1]", '#app > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > form:nth-child(1) > div:nth-child(2) > table:nth-child(1) > tbody:nth-child(2) > tr:nth-child(1)', "//tr[contains(@class,'orangehrm-timesheet-table-body-row')]"]
    element = get_element(driver,element_locators)

    'This Instruction Is Carried Out By The Vision Model'
    driver.implicitly_wait(6)

    # Step - 17 : set the value of variable 'assertion_operand_e32994f138dc4dc1a713f4029dbd53f2_0' to true
    assertion_operand_e32994f138dc4dc1a713f4029dbd53f2_0 = "true"
    driver.implicitly_wait(6)
