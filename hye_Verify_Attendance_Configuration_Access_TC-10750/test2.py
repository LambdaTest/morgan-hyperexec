...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_8b302d1495194e3ea1fb85b0c3769ac8_0' to true
    assertion_operand_8b302d1495194e3ea1fb85b0c3769ac8_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 14 : set the value of variable 'assertion_operand_886041d5ea5c4ea5ab3df65a4af8eb81_0' to configure
    assertion_operand_886041d5ea5c4ea5ab3df65a4af8eb81_0 = "configure"
    driver.implicitly_wait(6)

    # Step - 15 : Assert if '{{url}}' contains 'configure'
    assertion_operand_886041d5ea5c4ea5ab3df65a4af8eb81_0 = "configure"
    driver.implicitly_wait(6)

    # Step - 16 : Query 'Attendance Configuration' text visibility
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 17 : set the value of variable 'assertion_operand_b58362c5e8ad4a779e43515d662d447b_0' to true
    assertion_operand_b58362c5e8ad4a779e43515d662d447b_0 = "true"
    driver.implicitly_wait(6)

    # Step - 18 : Assert 'Attendance Configuration' text is displayed
    assertion_operand_b58362c5e8ad4a779e43515d662d447b_0 = "true"
