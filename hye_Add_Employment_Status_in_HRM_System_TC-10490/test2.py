...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_d463a67e0ff14d42beda18ca72073220_0' to true
    assertion_operand_d463a67e0ff14d42beda18ca72073220_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 18 : set the value of variable 'assertion_operand_25c3255df87c4d91919444ee72211790_0' to true
    assertion_operand_25c3255df87c4d91919444ee72211790_0 = "true"
    driver.implicitly_wait(6)

    # Step - 19 : Assert 'Required' text is visible on viewport
    assertion_operand_25c3255df87c4d91919444ee72211790_0 = "true"
