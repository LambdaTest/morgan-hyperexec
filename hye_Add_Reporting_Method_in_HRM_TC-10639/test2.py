...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_c7a71671302c403d9d3c1491743a79df_0' to true
    assertion_operand_c7a71671302c403d9d3c1491743a79df_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 16 : set the value of variable 'assertion_operand_0944adf9faa0447da215cf14191f20ce_0' to true
    assertion_operand_0944adf9faa0447da215cf14191f20ce_0 = "true"
    driver.implicitly_wait(6)

    # Step - 17 : Assert 'Required' text is visible on viewport
    assertion_operand_0944adf9faa0447da215cf14191f20ce_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 19 : Query 'Reporting Methods' text visibility
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 20 : set the value of variable 'assertion_operand_5cd964d22c394b3c916aafb31d8b6296_0' to true
    assertion_operand_5cd964d22c394b3c916aafb31d8b6296_0 = "true"
    driver.implicitly_wait(6)

    # Step - 21 : Assert 'Reporting Methods' text is visible
    assertion_operand_5cd964d22c394b3c916aafb31d8b6296_0 = "true"
