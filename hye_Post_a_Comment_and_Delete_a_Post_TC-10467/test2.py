...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_9f3e65fe17554ddbbbd41576dd4c22ed_0' to true
    assertion_operand_9f3e65fe17554ddbbbd41576dd4c22ed_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 11 : Type in What's on your mind? textarea 'okay'
    element_locators = ['[placeholder="What\'s on your mind?"]', '.oxd-buzz-post--focus > textarea', '.oxd-buzz-post--focus > textarea:nth-child(1)', '.oxd-buzz-post--focus > textarea:nth-child(1)', "//div[contains(@class,'oxd-buzz-post--focus')]/textarea[1]", "//div[contains(@class,'oxd-buzz-post--focus')]/textarea[1]"]
    element = get_element(driver,element_locators)
    ...
    # Step - 13 : Click on the chat icon in the top right corner
    element_locators = ["//div[@id='app']/div[1]/div[2]/div[2]/div[1]/div[1]/div[1]/div[3]/div[1]/div[1]/div[3]/div[1]/button[1]/i[1]", '#app > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(4) > div:nth-child(1) > div:nth-child(1) > div:nth-child(3) > div:nth-child(1) > button:nth-child(2) > i:nth-child(1)']
    element = get_element(driver,element_locators)
    ...
    # Step - 14 : Type in comment input field with placeholder 'Write your comment...' 'comment using button'
    ...
    driver.execute_script("arguments[0].value = '';", element)
    if element.get_attribute("pattern") and '[0-9]{2}' in element.get_attribute("pattern"):
        for char in 'comment using button':
            element.send_keys(char)
    else:
        element.send_keys('comment using button')
    driver.implicitly_wait(6)
    ...
    # Step - 16 : Query 'comment using button' visibility
    element_locators = ["//div[@id='app']/div[1]/div[2]/div[2]/div[1]/div[1]/div[1]/div[3]/div[1]/div[1]/div[4]/div[2]/div[2]/div[1]/span[1]", '#app > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(4) > div:nth-child(1) > div:nth-child(1) > div:nth-child(5) > div:nth-child(3) > div:nth-child(2) > div:nth-child(1) > span:nth-child(2)', "//span[text()='comment using button']"]
    element = get_element(driver,element_locators)

    'This Instruction Is Carried Out By The Vision Model'
    driver.implicitly_wait(6)

    # Step - 17 : set the value of variable 'assertion_operand_a6a59e026a044d68829d1d5c95ad191c_0' to true
    assertion_operand_a6a59e026a044d68829d1d5c95ad191c_0 = "true"
    driver.implicitly_wait(6)

    # Step - 18 : Assert 'comment using button' is visible
    assertion_operand_a6a59e026a044d68829d1d5c95ad191c_0 = "true"
    driver.implicitly_wait(6)

    # Step - 19 : Click on the three dots menu icon on post by Pushpa Raj
    ...
    # Step - 20 : Click on 'Delete Post' option in post action menu
    ...
    # Step - 21 : Click on Yes, Delete button in confirmation popup
