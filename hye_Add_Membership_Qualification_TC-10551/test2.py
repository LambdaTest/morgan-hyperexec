...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_b1750466e7a944d385c64d7a25b4b911_0' to true
    assertion_operand_b1750466e7a944d385c64d7a25b4b911_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 12 : Click 'Membership' dropdown
    element_locators = ["//nav[@role='navigation' and @aria-label='Topbar Menu']/ul[1]/li[4]/ul[1]/li[5]/a[1]", "//a[text()='Memberships']", "//a[contains(text(),'Memberships')]", '[aria-label="Topbar Menu"] > ul:nth-child(1) > li:nth-child(4) > ul:nth-child(2) > li:nth-child(5) > a:nth-child(1)']
    element = get_element(driver,element_locators)
    ...
    # Step - 16 : set the value of variable 'assertion_operand_24f953a8dc6849c9b30effcf32babad0_0' to true
    assertion_operand_24f953a8dc6849c9b30effcf32babad0_0 = "true"
    driver.implicitly_wait(6)
