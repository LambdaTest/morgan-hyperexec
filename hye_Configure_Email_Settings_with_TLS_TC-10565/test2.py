...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_c34718e44c9c436ca9c52b086055af75_0' to true
    assertion_operand_c34718e44c9c436ca9c52b086055af75_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 14 : Click 'TLS' toggle button
    element_locators = ['.orangehrm-input-field-bottom-space > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > label:nth-child(1) > input:nth-child(1)', "//div[contains(@class,'orangehrm-input-field-bottom-space')]/div[1]/div[1]/div[1]/div[1]/label[1]/input[1]"]
    element = get_element(driver,element_locators)
    ...
    # Step - 16 : Query 'TLS' button disabled state
    element_locators = ['.orangehrm-input-field-bottom-space > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > label:nth-child(1) > input:nth-child(1)', "//div[contains(@class,'orangehrm-input-field-bottom-space')]/div[1]/div[1]/div[1]/div[1]/label[1]/input[1]"]
    element = get_element(driver,element_locators)
    ...
    # Step - 17 : set the value of variable 'assertion_operand_baedc83400f043d2ad7c88d650e40f81_0' to true
    assertion_operand_baedc83400f043d2ad7c88d650e40f81_0 = "true"
    driver.implicitly_wait(6)

    # Step - 18 : Assert 'TLS' button is disabled
    assertion_operand_baedc83400f043d2ad7c88d650e40f81_0 = "true"
