...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_acf862e8b94b46309c1e5aa54f9fc369_0' to true
    assertion_operand_acf862e8b94b46309c1e5aa54f9fc369_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 12 : Click 'Job Categories' from the dropdown
    element_locators = ["//nav[@role='navigation' and @aria-label='Topbar Menu']/ul[1]/li[2]/ul[1]/li[4]/a[1]", "//a[text()='Job Categories']", "//a[contains(text(),'Job Categories')]", '[aria-label="Topbar Menu"] > ul:nth-child(1) > li:nth-child(2) > ul:nth-child(2) > li:nth-child(4) > a:nth-child(1)']
    element = get_element(driver,element_locators)
    ...
    # Step - 16 : type 'abc' in name section
    ...
    # Step - 18 : wait 5 seconds
    time.sleep(int(5))
    driver.implicitly_wait(6)

    # Step - 19 : Query if 'abc' text is visible
    element_locators = ["//div[@id='app']/div[1]/div[2]/div[2]/div[1]/div[1]/div[3]/div[1]/div[2]/div[1]/div[1]/div[2]", '[role="table"] > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2)', '[role="table"] > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2)']
    element = get_element(driver,element_locators)

    'This Instruction Is Carried Out By The Vision Model'
    driver.implicitly_wait(6)

    # Step - 20 : set the value of variable 'assertion_operand_41e46ba759654cce9a4b7e60e5b11561_0' to true
    assertion_operand_41e46ba759654cce9a4b7e60e5b11561_0 = "true"
    driver.implicitly_wait(6)

    # Step - 21 : Assert 'abc' text is visible on viewport
    assertion_operand_41e46ba759654cce9a4b7e60e5b11561_0 = "true"
    driver.implicitly_wait(6)

    # Step - 22 : Click 'Delete' icon
    ...
    # Step - 23 : Click 'Yes,Delete' button
