...
class FirstSampleTest(unittest.TestCase):
    ...
    def test_demo_site(self):
        ...
        try:
            ...
            # Query if 'abc' text is visible
            lambda_hooks(driver, "Query if 'abc' text is visible")
            abc_visible = vision_query(driver = driver, operation_index = str(10))
            ...
            # set the value of variable 'assertion_operand_41e46ba759654cce9a4b7e60e5b11561_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_41e46ba759654cce9a4b7e60e5b11561_0' to true")
