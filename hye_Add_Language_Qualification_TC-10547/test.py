...
class FirstSampleTest(unittest.TestCase):
    ...
    def test_demo_site(self):
        ...
        try:
            ...
            lambda_hooks(driver, "Click 'Languages' dropdown")
            ...
            # Click 'Save'
            lambda_hooks(driver, "Click 'Save'")
            ui_action(driver = driver, operation_index = str(5))

            # Query if 'Required' text is visible
            lambda_hooks(driver, "Query if 'Required' text is visible")
            required_visible = vision_query(driver = driver, operation_index = str(6))
            ...
            # set the value of variable 'assertion_operand_64fb0139fd974c9b9ffaee867890dd31_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_64fb0139fd974c9b9ffaee867890dd31_0' to true")
            ...
            no_records_found_displayed = vision_query(driver = driver, operation_index = str(11))
            if isinstance(no_records_found_displayed, dict):
                no_records_found_displayed = no_records_found_displayed.get("vision_query")
            user_variables["no_records_found_displayed"] =  no_records_found_displayed
            print("no_records_found_displayed:", no_records_found_displayed)

            # set the value of variable 'assertion_operand_b5335889d1024cec857a87db31fb35c7_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_b5335889d1024cec857a87db31fb35c7_0' to true")
