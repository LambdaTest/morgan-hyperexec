...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_e71aa566fe844ef59242491ed3420f72_0' to true
    assertion_operand_e71aa566fe844ef59242491ed3420f72_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 12 : Click 'Languages' dropdown
    element_locators = ["//nav[@role='navigation' and @aria-label='Topbar Menu']/ul[1]/li[4]/ul[1]/li[4]/a[1]", "//a[text()='Languages']", "//a[contains(text(),'Languages')]", '[aria-label="Topbar Menu"] > ul:nth-child(1) > li:nth-child(4) > ul:nth-child(2) > li:nth-child(4) > a:nth-child(1)']
    element = get_element(driver,element_locators)
    ...
    # Step - 15 : Query if 'Required' text is visible
    ...
    # Step - 16 : set the value of variable 'assertion_operand_64fb0139fd974c9b9ffaee867890dd31_0' to true
    assertion_operand_64fb0139fd974c9b9ffaee867890dd31_0 = "true"
    driver.implicitly_wait(6)

    # Step - 17 : Assert 'Required' text is visible on the viewport
    assertion_operand_64fb0139fd974c9b9ffaee867890dd31_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 19 : wait 2 seconds
    time.sleep(int(2))
    driver.implicitly_wait(6)

    # Step - 20 : Query if 'No Records Found' is displayed
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 21 : set the value of variable 'assertion_operand_b5335889d1024cec857a87db31fb35c7_0' to true
    assertion_operand_b5335889d1024cec857a87db31fb35c7_0 = "true"
    driver.implicitly_wait(6)

    # Step - 22 : Assert 'No Records Found' is displayed on viewport
    assertion_operand_b5335889d1024cec857a87db31fb35c7_0 = "true"
