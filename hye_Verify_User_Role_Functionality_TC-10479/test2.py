...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_25e288fb57314df3b8ded28abf87bfa6_0' to true
    assertion_operand_25e288fb57314df3b8ded28abf87bfa6_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 10 : Click 'User Role' dropdown
    element_locators = ["//div[@id='app']/div[1]/div[2]/div[2]/div[1]/div[1]/div[2]/form[1]/div[1]/div[1]/div[2]/div[1]/div[2]/div[1]/div[1]/div[1]", '#app > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(3) > form:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(1) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1)']
    element = get_element(driver,element_locators)
    ...
    # Step - 11 : Click 'ESS' option from the dropdown
    ...
    # Step - 15 : Query if 'No Records Found' is displayed
    ...
    # Step - 16 : set the value of variable 'assertion_operand_3f12d01e35e44a6098703a620b32b95e_0' to true
    assertion_operand_3f12d01e35e44a6098703a620b32b95e_0 = "true"
    driver.implicitly_wait(6)

    # Step - 17 : Assert 'No Records Found' is displayed on viewport
    assertion_operand_3f12d01e35e44a6098703a620b32b95e_0 = "true"
    driver.implicitly_wait(6)

    # Step - 18 : wait 1 second
    time.sleep(int(1))
    driver.implicitly_wait(6)

    # Step - 19 : Click 'User Role' dropdown
    element_locators = ["//div[@id='app']/div[1]/div[2]/div[2]/div[1]/div[1]/div[2]/form[1]/div[1]/div[1]/div[2]/div[1]/div[2]/div[1]/div[1]/div[1]", '#app > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(3) > form:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(1) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1)', "//div[text()='ESS']", "//div[contains(text(),'ESS')]"]
    element = get_element(driver,element_locators)
    ...
    # Step - 20 : Click 'Admin' option from dropdown
    ...
    # Step - 22 : wait 5 seconds
    time.sleep(int(5))
    driver.implicitly_wait(6)

    # Step - 23 : Query '(2) Record Found' text visibility
    element_locators = ["//div[@id='app']/div[1]/div[2]/div[2]/div[1]/div[2]/div[2]", '#app > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(3) > div:nth-child(2)']
    element = get_element(driver,element_locators)
    ...
    # Step - 24 : set the value of variable 'assertion_operand_1d11b5b0dfda4e4091a6eab814d7d4db_0' to true
    assertion_operand_1d11b5b0dfda4e4091a6eab814d7d4db_0 = "true"
    driver.implicitly_wait(6)

    # Step - 25 : Assert '(2) Record Found' text is displayed
    assertion_operand_1d11b5b0dfda4e4091a6eab814d7d4db_0 = "true"
