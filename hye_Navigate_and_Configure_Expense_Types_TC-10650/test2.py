...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_2dffcf82b1d44dcda2f09505f209f41a_0' to true
    assertion_operand_2dffcf82b1d44dcda2f09505f209f41a_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 11 : Click on Expense Types tab in top navigation bar
    ...
    # Step - 13 : set the value of variable 'assertion_operand_1b5f4776b88343c19c3971efb3223a70_0' to ViewExpense
    assertion_operand_1b5f4776b88343c19c3971efb3223a70_0 = "ViewExpense"
    driver.implicitly_wait(6)

    # Step - 14 : Assert current URL contains 'ViewExpense'
    assertion_operand_1b5f4776b88343c19c3971efb3223a70_0 = "ViewExpense"
    driver.implicitly_wait(6)

    # Step - 15 : Click on the up caret icon in the top right of Expense Types section
    ...
    # Step - 16 : Click on the collapse icon in the top right of Expense Types section
    element_locators = ['.oxd-table-filter-header-options > div:nth-child(3) > button:nth-child(1) > i:nth-child(1)', '.oxd-table-filter-header-options > div:nth-child(3) > button:nth-child(1) > i:nth-child(1)', "//div[contains(@class,'oxd-table-filter-header-options')]/div[3]/button[1]/i[1]", "//div[contains(@class,'oxd-table-filter-header-options')]/div[3]/button[1]/i[1]"]
    element = get_element(driver,element_locators)
