...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_39d0254776e84dfa8d5b796538654ce0_0' to true
    assertion_operand_39d0254776e84dfa8d5b796538654ce0_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 15 : Query 'Required' text visibility
    ...
    # Step - 16 : set the value of variable 'assertion_operand_c10e7a1304604a1c9fbad6812aedd0cb_0' to true
    assertion_operand_c10e7a1304604a1c9fbad6812aedd0cb_0 = "true"
    driver.implicitly_wait(6)
    ...
    element_locators = ['.oxd-button--ghost', '.oxd-button--medium.oxd-button--ghost', 'button:has(+ [type="submit"])', '.oxd-sheet--rounded > form:nth-child(4) > div:nth-child(4) > button:nth-child(2)', "//button[contains(@class,'oxd-button--ghost')]", "//div[contains(@class,'oxd-sheet--rounded') and contains(@class,'oxd-sheet--white') and contains(@class,'oxd-dialog-sheet--shadow') and contains(@class,'oxd-dialog-sheet--gutters')]/form[1]/div[3]/button[1]", "//button[contains(@class,'oxd-button--medium') and contains(@class,'oxd-button--ghost')]", "//div[contains(@class,'oxd-sheet--rounded')]/form[1]/div[3]/button[1]"]
    element = get_element(driver,element_locators)
