...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_e614c65ff3ac446593272397c1095222_0' to true
    assertion_operand_e614c65ff3ac446593272397c1095222_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 14 : Query 'ayush' text visibility
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 15 : set the value of variable 'assertion_operand_3f10fa5b23bc4a90801f288462d69ca7_0' to true
    assertion_operand_3f10fa5b23bc4a90801f288462d69ca7_0 = "true"
    driver.implicitly_wait(6)

    # Step - 16 : Assert 'ayush' text is displayed on viewport
    assertion_operand_3f10fa5b23bc4a90801f288462d69ca7_0 = "true"
    driver.implicitly_wait(6)

    # Step - 17 : Query 'pushpa' text visibility
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 18 : set the value of variable 'assertion_operand_9967601096484674a7eaa426221cbd69_0' to true
    assertion_operand_9967601096484674a7eaa426221cbd69_0 = "true"
    driver.implicitly_wait(6)

    # Step - 19 : Assert 'pushpa' text is displayed on viewport
    assertion_operand_9967601096484674a7eaa426221cbd69_0 = "true"
