...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_4d498643b67347cb98cb8fc4b16ba220_0' to true
    assertion_operand_4d498643b67347cb98cb8fc4b16ba220_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 11 : Click on 'Configuration' dropdown in the top left navigation bar 
    ...
    # Step - 13 : Click on 'Expense Types' menu item in the left side vertical menu under Claim 
    ...
    # Step - 15 : Click on the expense name input field with placeholder 'Type for hints...' 
    ...
    # Step - 16 : Type in expense type name input field 'active' 
    element_locators = ['[placeholder="Type for hints..."]', '.oxd-autocomplete-text-input--focus > input', '.oxd-autocomplete-text-input--before + input', 'input:has(+ .oxd-autocomplete-text-input--after)', "//input[starts-with(@placeholder,'Type ')]", "//div[contains(@class,'oxd-autocomplete-text-input--focus')]/input[1]", "//input[contains(@placeholder,'Type for hints...')]", "//div[contains(@class,'oxd-autocomplete-text-input--focus')]/input[1]"]
    element = get_element(driver,element_locators)
    ...
    # Step - 17 : Click on the status dropdown in expense types section 
    ...
    # Step - 18 : Click on the Search button in Expense Types section 
    ...
    # Step - 19 : Query text '(2) Records Found' visibility
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 20 : set the value of variable 'assertion_operand_18cb45e57e8a470085f0ca3e2878fcaf_0' to true
    assertion_operand_18cb45e57e8a470085f0ca3e2878fcaf_0 = "true"
    driver.implicitly_wait(6)

    # Step - 21 : Assert text '(2) Records Found' is visible
    assertion_operand_18cb45e57e8a470085f0ca3e2878fcaf_0 = "true"
    driver.implicitly_wait(6)

    # Step - 22 : Query 'Inactive' text visibility
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 23 : set the value of variable 'assertion_operand_9768de8a62fd4969bdcfe00be20c01f5_0' to true
    assertion_operand_9768de8a62fd4969bdcfe00be20c01f5_0 = "true"
    driver.implicitly_wait(6)

    # Step - 24 : Assert 'Inactive' text is visible
    assertion_operand_9768de8a62fd4969bdcfe00be20c01f5_0 = "true"
    driver.implicitly_wait(6)

    # Step - 25 : Query 'Active Expense name' visibility
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 26 : set the value of variable 'assertion_operand_94582f5af2bf45e196471a7fecc15c6b_0' to true
    assertion_operand_94582f5af2bf45e196471a7fecc15c6b_0 = "true"
    driver.implicitly_wait(6)

    # Step - 27 : Assert 'Active Expense name' is visible
    assertion_operand_94582f5af2bf45e196471a7fecc15c6b_0 = "true"
    driver.implicitly_wait(6)

    # Step - 28 : Query 'Active Expense name' visibility
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 29 : set the value of variable 'assertion_operand_92e96bf1b6ad4b22a70e632477db8496_0' to true
    assertion_operand_92e96bf1b6ad4b22a70e632477db8496_0 = "true"
    driver.implicitly_wait(6)

    # Step - 30 : Assert 'Active Expense name' is visible
    assertion_operand_92e96bf1b6ad4b22a70e632477db8496_0 = "true"
    driver.implicitly_wait(6)

    # Step - 31 : Query 'Inactive Expense name' visibility
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 32 : set the value of variable 'assertion_operand_2ab7828726a84bc89c0c56bb48206c55_0' to true
    assertion_operand_2ab7828726a84bc89c0c56bb48206c55_0 = "true"
    driver.implicitly_wait(6)

    # Step - 33 : Assert 'Inactive Expense name' is visible
    assertion_operand_2ab7828726a84bc89c0c56bb48206c55_0 = "true"
