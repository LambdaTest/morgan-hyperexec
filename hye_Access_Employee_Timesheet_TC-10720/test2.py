...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_e0a038696b4844148b5a179a6a7e7e57_0' to true
    assertion_operand_e0a038696b4844148b5a179a6a7e7e57_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 12 : set the value of variable 'assertion_operand_6ec406ad9df241c1918ab85e6a6fdf39_0' to viewEmployeeTimesheet
    assertion_operand_6ec406ad9df241c1918ab85e6a6fdf39_0 = "viewEmployeeTimesheet"
    driver.implicitly_wait(6)

    # Step - 13 : Assert '{{url}}' contains 'viewEmployeeTimesheet'
    assertion_operand_6ec406ad9df241c1918ab85e6a6fdf39_0 = "viewEmployeeTimesheet"
    driver.implicitly_wait(6)

    # Step - 14 : Query 'No Records found' text visibility
    ...
    # Step - 15 : set the value of variable 'assertion_operand_0e1447e73fcc415f890802e7ea8f0dc7_0' to true
    assertion_operand_0e1447e73fcc415f890802e7ea8f0dc7_0 = "true"
    driver.implicitly_wait(6)

    # Step - 16 : Assert 'No Records found' text is displayed
    assertion_operand_0e1447e73fcc415f890802e7ea8f0dc7_0 = "true"
