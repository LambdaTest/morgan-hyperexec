...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_e39061e55a62478bb3abacb6379775e6_0' to true
    assertion_operand_e39061e55a62478bb3abacb6379775e6_0 = "true"
    driver.implicitly_wait(6)
    ...
    element_locators = ['.oxd-button--medium', '.oxd-button--secondary', '.oxd-button--medium.oxd-button--secondary', "//div[@id='app']/div[1]/div[2]/div[2]/div[1]/div[1]/div[1]/button[1]", '#app > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > button:nth-child(2)', "//button[contains(@class,'oxd-button--medium')]", "//button[contains(@class,'oxd-button--secondary')]", "//button[contains(@class,'oxd-button--medium') and contains(@class,'oxd-button--secondary')]"]
    element = get_element(driver,element_locators)
    ...
    # Step - 16 : set the value of variable 'assertion_operand_f6f7b6a3b3ee462cb662abbbd8e507f0_0' to true
    assertion_operand_f6f7b6a3b3ee462cb662abbbd8e507f0_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 18 : type 'abc' in field name
