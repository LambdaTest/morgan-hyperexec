...
class FirstSampleTest(unittest.TestCase):
    ...
    def test_demo_site(self):
        ...
        try:
            ...
            # Query if 'Required' text is visible near 'Name'
            lambda_hooks(driver, "Query if 'Required' text is visible near 'Name'")
            ...
            # set the value of variable 'assertion_operand_8d8a3901f8af437fafa47d28b9f23e89_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_8d8a3901f8af437fafa47d28b9f23e89_0' to true")
            ...
            # Query if 'Required' text is displayed for country
            lambda_hooks(driver, "Query if 'Required' text is displayed for country")
            required_text_displayed = vision_query(driver = driver, operation_index = str(14))
            if isinstance(required_text_displayed, dict):
                required_text_displayed = required_text_displayed.get("vision_query")
            user_variables["required_text_displayed"] =  required_text_displayed
            print("required_text_displayed:", required_text_displayed)

            # set the value of variable 'assertion_operand_e824b386d60d419a81ad483b9fcbab63_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_e824b386d60d419a81ad483b9fcbab63_0' to true")
