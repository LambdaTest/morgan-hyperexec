...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_2e8eb15421874b4c966c01df6b88f802_0' to true
    assertion_operand_2e8eb15421874b4c966c01df6b88f802_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 18 : set the value of variable 'assertion_operand_265a931552914c69932ccf91556d20f8_0' to true
    ...
    # Step - 20 : type 'abc' in name
    element_locators = ['.oxd-input--error', "//div[@id='app']/div[1]/div[2]/div[2]/div[1]/div[1]/form[1]/div[1]/div[1]/div[1]/div[2]/input[1]", '#app > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > form:nth-child(3) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > input:nth-child(1)', "//input[contains(@class,'oxd-input--error')]"]
    element = get_element(driver,element_locators)
