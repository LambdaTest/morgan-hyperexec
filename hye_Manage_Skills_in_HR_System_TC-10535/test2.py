...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_acd415f991a54ec3908a838f03294500_0' to true
    assertion_operand_acd415f991a54ec3908a838f03294500_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 14 : type 'abc' in name
    element_locators = ["//div[@id='app']/div[1]/div[2]/div[2]/div[1]/div[1]/form[1]/div[1]/div[1]/div[2]/input[1]", '#app > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > form:nth-child(3) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > input:nth-child(1)']
    element = get_element(driver,element_locators)
    ...
    # Step - 17 : Query if 'abc' text is displayed on viewport
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 18 : set the value of variable 'assertion_operand_3f474e5590ac48f8929ac69a530a4ee7_0' to true
    assertion_operand_3f474e5590ac48f8929ac69a530a4ee7_0 = "true"
    driver.implicitly_wait(6)

    # Step - 19 : Assert 'abc' text is displayed on viewport
    assertion_operand_3f474e5590ac48f8929ac69a530a4ee7_0 = "true"
    driver.implicitly_wait(6)

    # Step - 20 : Click 'Delete' icon
    ...
    # Step - 21 : Click 'Yes,Delete' button
    ...
    # Step - 23 : Query 'abc' text visibility
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 24 : set the value of variable 'assertion_operand_ceb8c7f23c484fb6afe57142049e2ef3_0' to false
    assertion_operand_ceb8c7f23c484fb6afe57142049e2ef3_0 = "false"
    driver.implicitly_wait(6)

    # Step - 25 : Assert 'abc' text is not displayed on viewport
    assertion_operand_ceb8c7f23c484fb6afe57142049e2ef3_0 = "false"
