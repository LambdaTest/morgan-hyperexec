...
class FirstSampleTest(unittest.TestCase):
    ...
    def test_demo_site(self):
        ...
        try:
            ...
            # Query 'Rejected' text visibility
            lambda_hooks(driver, "Query 'Rejected' text visibility")
            Rejected_visible = vision_query(driver = driver, operation_index = str(4))
            ...
            # set the value of variable 'assertion_operand_887312804b804e56b831c38b40eebbaf_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_887312804b804e56b831c38b40eebbaf_0' to true")
            ...
            # set the value of variable 'assertion_operand_91a9117b1c28496cbfa957f650bb8b4b_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_91a9117b1c28496cbfa957f650bb8b4b_0' to true")
