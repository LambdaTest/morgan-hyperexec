...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_b5120f5a7c004740bbcf5944845e9b39_0' to true
    assertion_operand_b5120f5a7c004740bbcf5944845e9b39_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 12 : Click 'Register OAuth Client' dropdown
    element_locators = ["//nav[@role='navigation' and @aria-label='Topbar Menu']/ul[1]/li[7]/ul[1]/li[7]/a[1]", "//a[text()='Register OAuth Client']", "//a[contains(text(),'Register OAuth Client')]", '[aria-label="Topbar Menu"] > ul:nth-child(1) > li:nth-child(7) > ul:nth-child(2) > li:nth-child(7) > a:nth-child(1)']
    element = get_element(driver,element_locators)
    ...
    # Step - 14 : set the value of variable 'assertion_operand_b08c9b1ea2e3483f852c86e07a9846f6_0' to registerOAuthClient
    assertion_operand_b08c9b1ea2e3483f852c86e07a9846f6_0 = "registerOAuthClient"
    driver.implicitly_wait(6)

    # Step - 15 : Assert '{{url}}' contains 'registerOAuthClient'
    assertion_operand_b08c9b1ea2e3483f852c86e07a9846f6_0 = "registerOAuthClient"
    driver.implicitly_wait(6)

    # Step - 16 : Query '(1) Records found' text visibility
    ...
    # Step - 17 : set the value of variable 'assertion_operand_a077adecb08e490eaf3e314f999d12a2_0' to true
    assertion_operand_a077adecb08e490eaf3e314f999d12a2_0 = "true"
    driver.implicitly_wait(6)

    # Step - 18 : Assert '(1) Records found' text is displayed
    assertion_operand_a077adecb08e490eaf3e314f999d12a2_0 = "true"
