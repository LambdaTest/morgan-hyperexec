...
class FirstSampleTest(unittest.TestCase):
    ...
    def test_demo_site(self):
        ...
        try:
            ...
            # Click on the Immigration tab in the left side menu
            lambda_hooks(driver, "Click on the Immigration tab in the left side menu")
            ...
            # set the value of variable 'assertion_operand_ae8ef5d111cc4b44bac4e4a134db9aa0_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_ae8ef5d111cc4b44bac4e4a134db9aa0_0' to true")
            ...
            # set the value of variable 'assertion_operand_3b036fe72054429caebbd07733d805fa_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_3b036fe72054429caebbd07733d805fa_0' to true")
            ...
            # set the value of variable 'assertion_operand_0a2c1325aa764473b16b2ae583d83e6e_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_0a2c1325aa764473b16b2ae583d83e6e_0' to true")
            ...
            # set the value of variable 'assertion_operand_ed183c6494164e6f9c1d4cd2497d0bbf_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_ed183c6494164e6f9c1d4cd2497d0bbf_0' to true")
            ...
            # set the value of variable 'assertion_operand_ec279636f3074bc6bb23ad2910345156_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_ec279636f3074bc6bb23ad2910345156_0' to true")
            ...
            # set the value of variable 'assertion_operand_db3e85c4b0c743b2882a36b85c8f9eaf_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_db3e85c4b0c743b2882a36b85c8f9eaf_0' to true")
            ...
            # set the value of variable 'assertion_operand_c2fc21841e324683a2a697a17bb0095b_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_c2fc21841e324683a2a697a17bb0095b_0' to true")
