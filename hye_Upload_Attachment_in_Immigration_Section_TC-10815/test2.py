...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_a7f759d62f36474688965f82d3192fd9_0' to true
    assertion_operand_a7f759d62f36474688965f82d3192fd9_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 11 : Click on the Immigration tab in the left side menu
    ...
    # Step - 15 : set the value of variable 'assertion_operand_ae8ef5d111cc4b44bac4e4a134db9aa0_0' to true
    assertion_operand_ae8ef5d111cc4b44bac4e4a134db9aa0_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 18 : set the value of variable 'assertion_operand_3b036fe72054429caebbd07733d805fa_0' to true
    assertion_operand_3b036fe72054429caebbd07733d805fa_0 = "true"
    driver.implicitly_wait(6)
    ...
    element_locators = ["//div[@id='app']/div[1]/div[2]/div[2]/div[1]/div[1]/div[1]/div[2]/div[5]/div[1]/form[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]", '#app > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(5) > div:nth-child(2) > form:nth-child(3) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1)', "//div[text()='Browse']", "//div[contains(text(),'Browse')]"]
    element = get_element(driver,element_locators)

    'This Instruction Is Carried Out By The Vision Model'
    driver.implicitly_wait(6)

    # Step - 21 : set the value of variable 'assertion_operand_0a2c1325aa764473b16b2ae583d83e6e_0' to true
    assertion_operand_0a2c1325aa764473b16b2ae583d83e6e_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 24 : set the value of variable 'assertion_operand_ed183c6494164e6f9c1d4cd2497d0bbf_0' to true
    assertion_operand_ed183c6494164e6f9c1d4cd2497d0bbf_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 26 : Query 'Comment' visibility
    ...
    # Step - 27 : set the value of variable 'assertion_operand_ec279636f3074bc6bb23ad2910345156_0' to true
    assertion_operand_ec279636f3074bc6bb23ad2910345156_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 30 : set the value of variable 'assertion_operand_db3e85c4b0c743b2882a36b85c8f9eaf_0' to true
    assertion_operand_db3e85c4b0c743b2882a36b85c8f9eaf_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 33 : set the value of variable 'assertion_operand_c2fc21841e324683a2a697a17bb0095b_0' to true
    assertion_operand_c2fc21841e324683a2a697a17bb0095b_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 35 : Upload file from variable '/home/kaneai/Downloads/Screenshot+2025-09-12+at+7.19.03%E2%80%AFPM.png'
