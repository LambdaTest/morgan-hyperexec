...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_d32e076b49834d3694165e1c35a52a88_0' to true
    assertion_operand_d32e076b49834d3694165e1c35a52a88_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 9 : Click on 'Maintenance' menu item in the left sidebar  
    ...
    # Step - 13 : wait 4 seconds
    time.sleep(int(4))
    driver.implicitly_wait(6)

    # Step - 14 : Click on 'Purge Records' dropdown in top left below header  
    element_locators = ['span.oxd-topbar-body-nav-tab-item', '.--parent > span', '.--visited > span', '.oxd-topbar-body-nav-tab.--parent > span', "//span[contains(text(),'Purge Records')]", "//li[contains(@class,'--parent')]/span[1]", "//li[contains(@class,'--visited')]/span[1]", "//span[contains(@class,'oxd-topbar-body-nav-tab-item')]"]
    element = get_element(driver,element_locators)
    ...
    # Step - 16 : Click on 'Candidate Records' option in Purge Records dropdown  
    element_locators = ["//a[text()='Candidate Records']", '[role="menu"] > li:nth-child(2) > a:nth-child(1)', '[role="menu"] > li:nth-child(2) > a:nth-child(1)', "//a[contains(text(),'Candidate Records')]", "//li[contains(@class,'--parent')]/ul[1]/li[2]/a[1]", "//li[contains(@class,'--visited')]/ul[1]/li[2]/a[1]"]
    element = get_element(driver,element_locators)
    ...
    # Step - 17 : wait 5 seconds
    time.sleep(int(5))
    driver.implicitly_wait(6)

    # Step - 18 : Get the current URL
    current_url = driver.current_url

    print("current_url:", current_url)
    driver.implicitly_wait(6)

    # Step - 19 : set the value of variable 'assertion_operand_cabe84d777604f8085a321a19213eb92_0' to purgeCandidateData
    assertion_operand_cabe84d777604f8085a321a19213eb92_0 = "purgeCandidateData"
    driver.implicitly_wait(6)

    # Step - 20 : Assert current URL contains 'purgeCandidateData'
    assertion_operand_cabe84d777604f8085a321a19213eb92_0 = "purgeCandidateData"
    driver.implicitly_wait(6)

    # Step - 21 : Click on the Search button in Purge Candidate Records section  
    ...
    # Step - 23 : Query 'Required' text visibility
    ...
    # Step - 24 : set the value of variable 'assertion_operand_d7c6b364fb4b48ba804969fe04174ff7_0' to true
    assertion_operand_d7c6b364fb4b48ba804969fe04174ff7_0 = "true"
    driver.implicitly_wait(6)

    # Step - 25 : Assert 'Required' text is visible
    assertion_operand_d7c6b364fb4b48ba804969fe04174ff7_0 = "true"
    driver.implicitly_wait(6)

    # Step - 26 : Click on vacancy input field with placeholder 'Type for hints...'  
    element_locators = ['[placeholder="Type for hints..."]', '.oxd-autocomplete-text-input--focus > input', '.oxd-autocomplete-text-input--error > input', '.oxd-autocomplete-text-input--before + input', "//input[starts-with(@placeholder,'Type ')]", "//div[contains(@class,'oxd-autocomplete-text-input--focus')]/input[1]", "//input[contains(@placeholder,'Type for hints...')]", "//div[contains(@class,'oxd-autocomplete-text-input--error')]/input[1]"]
    element = get_element(driver,element_locators)
    ...
    # Step - 27 : Type in vacancy input field with placeholder 'Type for hints...' 'ayush'  
    element_locators = ['[placeholder="Type for hints..."]', '.oxd-autocomplete-text-input--focus > input', '.oxd-autocomplete-text-input--error > input', '.oxd-autocomplete-text-input--before + input', "//input[starts-with(@placeholder,'Type ')]", "//div[contains(@class,'oxd-autocomplete-text-input--focus')]/input[1]", "//input[contains(@placeholder,'Type for hints...')]", "//div[contains(@class,'oxd-autocomplete-text-input--error')]/input[1]"]
    element = get_element(driver,element_locators)
    ...
    # Step - 28 : wait 2 seconds
    time.sleep(int(2))
    driver.implicitly_wait(6)

    # Step - 29 : Click 'Search button'
    element_locators = ['[type="submit"]', '.oxd-button--medium', '.oxd-button--secondary', '.oxd-button--medium.oxd-button--secondary', "//button[starts-with(@type,'submi')]", "//button[contains(@class,'oxd-button--medium')]", "//button[contains(@type,'submit')]", "//button[contains(@class,'oxd-button--secondary')]"]
    element = get_element(driver,element_locators)
    ...
    # Step - 31 : Query 'Invalid' text visibility
    ...
    # Step - 32 : set the value of variable 'assertion_operand_b2cba29163f54721a592feb76fa1e0e0_0' to true
    assertion_operand_b2cba29163f54721a592feb76fa1e0e0_0 = "true"
    driver.implicitly_wait(6)

    # Step - 33 : Assert 'Invalid' text is visible
    assertion_operand_b2cba29163f54721a592feb76fa1e0e0_0 = "true"
