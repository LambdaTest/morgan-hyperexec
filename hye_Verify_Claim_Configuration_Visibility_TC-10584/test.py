...
class FirstSampleTest(unittest.TestCase):
    ...
    def test_demo_site(self):
        ...
        try:
            ...
            # Click on 'Punched Out' status icon in Time at Work widget
            lambda_hooks(driver, "Click on 'Punched Out' status icon in Time at Work widget")
            ui_action(driver = driver, operation_index = str(2))

            # Query 'Name' visibility
            lambda_hooks(driver, "Query 'Name' visibility")
            Name_visible = vision_query(driver = driver, operation_index = str(3))
            ...
            # set the value of variable 'assertion_operand_ea9f4c47ef184ed69e40873fa928a4a1_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_ea9f4c47ef184ed69e40873fa928a4a1_0' to true")
            ...
            # Query 'Expense Types' visibility
            lambda_hooks(driver, "Query 'Expense Types' visibility")
            Expense_Types_visible = vision_query(driver = driver, operation_index = str(6))
            if isinstance(Expense_Types_visible, dict):
                Expense_Types_visible = Expense_Types_visible.get("vision_query")
            user_variables["Expense_Types_visible"] =  Expense_Types_visible
            print("Expense_Types_visible:", Expense_Types_visible)

            # set the value of variable 'assertion_operand_8efc1fa1de2d4171ac25e6b99ad08846_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_8efc1fa1de2d4171ac25e6b99ad08846_0' to true")
            ...
            Status_visible = vision_query(driver = driver, operation_index = str(9))
            ...
            # set the value of variable 'assertion_operand_f8f8d501edc34e4b81895c31a4ddffe6_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_f8f8d501edc34e4b81895c31a4ddffe6_0' to true")
            ...
            # set the value of variable 'assertion_operand_f229e9d4bdaa427aaef5fb6311a48199_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_f229e9d4bdaa427aaef5fb6311a48199_0' to true")
            ...
            Reset_visible = vision_query(driver = driver, operation_index = str(15))
            ...
            # set the value of variable 'assertion_operand_90f673a0b30d4a488087ccd8854a8394_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_90f673a0b30d4a488087ccd8854a8394_0' to true")
            ...
            # set the value of variable 'assertion_operand_115ab45096d048418198a128b72fdc2c_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_115ab45096d048418198a128b72fdc2c_0' to true")
