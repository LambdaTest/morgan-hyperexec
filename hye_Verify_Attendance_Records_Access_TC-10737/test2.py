...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_90835507cf9f401692cfd00b213f5661_0' to true
    assertion_operand_90835507cf9f401692cfd00b213f5661_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 14 : set the value of variable 'assertion_operand_972b09929d7c481c80c57d23015b6e97_0' to viewAttendanceRecord
    assertion_operand_972b09929d7c481c80c57d23015b6e97_0 = "viewAttendanceRecord"
    driver.implicitly_wait(6)

    # Step - 15 : Assert '{{url}}' contains 'viewAttendanceRecord'
    assertion_operand_972b09929d7c481c80c57d23015b6e97_0 = "viewAttendanceRecord"
    driver.implicitly_wait(6)

    # Step - 16 : Query if 'ayush' text is visible
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 17 : set the value of variable 'assertion_operand_e885f4c7edc34126a2b12941e8fb9b69_0' to true
    assertion_operand_e885f4c7edc34126a2b12941e8fb9b69_0 = "true"
    driver.implicitly_wait(6)

    # Step - 18 : Assert 'ayush' text is visible on viewport
    assertion_operand_e885f4c7edc34126a2b12941e8fb9b69_0 = "true"
