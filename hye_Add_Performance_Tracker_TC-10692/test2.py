...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_aad67b2b9c3042de87c706cd6b96019a_0' to true
    assertion_operand_aad67b2b9c3042de87c706cd6b96019a_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 9 : Click on 'Performance' menu item in left side menu
    ...
    # Step - 11 : Click on Configure dropdown in top left under Performance / Manage Reviews
    ...
    # Step - 16 : set the value of variable 'assertion_operand_82fcae5d5e284f20985e9023819032bf_0' to viewPerformanceTracker
    assertion_operand_82fcae5d5e284f20985e9023819032bf_0 = "viewPerformanceTracker"
    driver.implicitly_wait(6)

    # Step - 17 : Assert current URL contains 'viewPerformanceTracker'
    assertion_operand_82fcae5d5e284f20985e9023819032bf_0 = "viewPerformanceTracker"
    driver.implicitly_wait(6)

    # Step - 18 : Click on the Search button in Performance Trackers section
    ...
    # Step - 20 : set the value of variable 'assertion_operand_212fc791aaa54eba8ec59144543e9884_0' to true
    ...
    # Step - 22 : Click on the green Add button below Performance Trackers section
    ...
    # Step - 24 : set the value of variable 'assertion_operand_0826a354cb5643f5b33c2e11b7547386_0' to addPerformanceTracker
    assertion_operand_0826a354cb5643f5b33c2e11b7547386_0 = "addPerformanceTracker"
    driver.implicitly_wait(6)

    # Step - 25 : Assert current URL contains 'addPerformanceTracker'
    assertion_operand_0826a354cb5643f5b33c2e11b7547386_0 = "addPerformanceTracker"
    driver.implicitly_wait(6)

    # Step - 26 : Click on the Save button in Add Performance Tracker form
    ...
    # Step - 28 : set the value of variable 'assertion_operand_8ca4a058b67e497d91669fb7122529aa_0' to true
