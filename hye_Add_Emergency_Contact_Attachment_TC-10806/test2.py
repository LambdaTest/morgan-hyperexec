...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_f784c8bb630446ffa21c838e1b50f56f_0' to true
    assertion_operand_f784c8bb630446ffa21c838e1b50f56f_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 11 : Click on 'Emergency Contacts' tab in the left side menu under 'My Info'
    ...
    # Step - 13 : Click on the Add button in Attachments section
    ...
    # Step - 15 : set the value of variable 'assertion_operand_0aa2a0598d23440a956f4da7b55d7f5b_0' to true
    ...
    # Step - 18 : set the value of variable 'assertion_operand_81a4c7c799404c59b3427016756aa94f_0' to true
    ...
    # Step - 21 : set the value of variable 'assertion_operand_2b3095447ebc420db75589bc374265fa_0' to true
    ...
    # Step - 23 : Query visibility of text 'No File selected'
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 24 : set the value of variable 'assertion_operand_0171b753e789489eb9e7d248be3fa4b7_0' to true
    assertion_operand_0171b753e789489eb9e7d248be3fa4b7_0 = "true"
    driver.implicitly_wait(6)

    # Step - 25 : Assert text 'No File selected' is visible
    assertion_operand_0171b753e789489eb9e7d248be3fa4b7_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 27 : set the value of variable 'assertion_operand_1f9a6faabb1747abb784fc2866021bd1_0' to true
    ...
    # Step - 29 : Query 'Cancel' visibility
    ...
    # Step - 30 : set the value of variable 'assertion_operand_4d826664e79446b598b06d50e3e7da7a_0' to true
    assertion_operand_4d826664e79446b598b06d50e3e7da7a_0 = "true"
    driver.implicitly_wait(6)

    # Step - 31 : Assert 'Cancel' is visible on screen
    assertion_operand_4d826664e79446b598b06d50e3e7da7a_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 33 : set the value of variable 'assertion_operand_447730bf8cf041c78c1408e7effdc4d7_0' to true
    ...
    # Step - 37 : set the value of variable 'assertion_operand_793804f9c5bf4ed99cc99ecb3d27971b_0' to true
    ...
    # Step - 39 : Upload file from variable '/home/kaneai/Downloads/Screenshot+2025-09-12+at+7.19.03%E2%80%AFPM.png'
