...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_631e6fe33e6c4bef82306ba0a8e30aa6_0' to true
    assertion_operand_631e6fe33e6c4bef82306ba0a8e30aa6_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 9 : Click on 'Claim' menu item in the left sidebar
    ...
    # Step - 10 : Click on 'Configuration' dropdown in top left nav bar
    ...
    # Step - 11 : Click on 'Expense Types' menu item in the top left dropdown
    ...
    # Step - 13 : Type in expense type name input field with placeholder 'Type for hints...' 'inacti'
    element_locators = ['[placeholder="Type for hints..."]', '.oxd-autocomplete-text-input--focus > input', '.oxd-autocomplete-text-input--before + input', 'input:has(+ .oxd-autocomplete-text-input--after)', "//input[starts-with(@placeholder,'Type ')]", "//div[contains(@class,'oxd-autocomplete-text-input--focus')]/input[1]", "//input[contains(@placeholder,'Type for hints...')]", "//div[contains(@class,'oxd-autocomplete-text-input--focus')]/input[1]"]
    element = get_element(driver,element_locators)
    ...
    if element.get_attribute("pattern") and '[0-9]{2}' in element.get_attribute("pattern"):
        ...
        element.send_keys('inacti')
    driver.implicitly_wait(6)

    # Step - 14 : Click on the status dropdown caret up icon
    ...
    # Step - 17 : set the value of variable 'assertion_operand_9d6ae09f5b454ecf9c5131bdfe503641_0' to true
    ...
    # Step - 19 : Click on the checkbox for Inactive Expense name in the records list
    ...
    # Step - 21 : set the value of variable 'assertion_operand_9995b11d2c204c0483a2f94f434e0015_0' to true
    ...
    # Step - 23 : Click on the checkbox for inactive expense name in the expense list
    element_locators = ['.oxd-table-card-cell-checkbox > div:nth-child(1) > label:nth-child(1) > span:nth-child(2) > i:nth-child(1)', '.oxd-table-card-cell-checkbox > div:nth-child(1) > label:nth-child(1) > span:nth-child(2) > i:nth-child(1)', "//div[contains(@class,'oxd-table-card-cell-checkbox')]/div[1]/label[1]/span[1]/i[1]", "//div[contains(@class,'oxd-table-card-cell-checkbox')]/div[1]/label[1]/span[1]/i[1]"]
    element = get_element(driver,element_locators)
    ...
    # Step - 24 : Click on Reset button in Expense Types section
    ...
    # Step - 25 : Click on the collapse arrow button in the top right corner of Expense Types section
    element_locators = ['.oxd-table-filter-header-options > div:nth-child(3) > button:nth-child(1)', '.oxd-table-filter-header-options > div:nth-child(3) > button:nth-child(1)', "//div[contains(@class,'oxd-table-filter-header-options')]/div[3]/button[1]", "//div[contains(@class,'oxd-table-filter-header-options')]/div[3]/button[1]"]
    element = get_element(driver,element_locators)
