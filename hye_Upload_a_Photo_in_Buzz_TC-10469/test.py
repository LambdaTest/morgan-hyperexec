...
class FirstSampleTest(unittest.TestCase):
    ...
    def test_demo_site(self):
        ...
        try:
            ...
            # Click on the photo upload icon in share photos popup
            lambda_hooks(driver, "Click on the photo upload icon in share photos popup")
            ...
            # Click on the close icon in share photos popup
            lambda_hooks(driver, "Click on the close icon in share photos popup")
