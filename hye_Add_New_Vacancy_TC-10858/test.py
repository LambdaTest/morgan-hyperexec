...
class FirstSampleTest(unittest.TestCase):
    ...
    def test_demo_site(self):
        ...
        try:
            ...
            # set the value of variable 'assertion_operand_64d12678859e40deaa1f35440ebf5dab_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_64d12678859e40deaa1f35440ebf5dab_0' to true")
