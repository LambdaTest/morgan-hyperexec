...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_88b6612038b64cecb2b07a0e728744a7_0' to true
    assertion_operand_88b6612038b64cecb2b07a0e728744a7_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 15 : set the value of variable 'assertion_operand_98def7c2fe8d414fb1cd13c33339d286_0' to viewProjects
    assertion_operand_98def7c2fe8d414fb1cd13c33339d286_0 = "viewProjects"
    driver.implicitly_wait(6)

    # Step - 16 : Assert '{{url}}' contains 'viewProjects'
    assertion_operand_98def7c2fe8d414fb1cd13c33339d286_0 = "viewProjects"
    driver.implicitly_wait(6)

    # Step - 17 : Query if 'No Records found' text is visible
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 18 : set the value of variable 'assertion_operand_a09eb6acc6c64972932d4590f3213315_0' to true
    assertion_operand_a09eb6acc6c64972932d4590f3213315_0 = "true"
    driver.implicitly_wait(6)
