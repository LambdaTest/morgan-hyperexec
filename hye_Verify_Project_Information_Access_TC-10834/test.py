...
class FirstSampleTest(unittest.TestCase):
    ...
    def test_demo_site(self):
        ...
        try:
            ...
            # set the value of variable 'assertion_operand_98def7c2fe8d414fb1cd13c33339d286_0' to viewProjects
            lambda_hooks(driver, "set the value of variable 'assertion_operand_98def7c2fe8d414fb1cd13c33339d286_0' to viewProjects")
            ...
            # set the value of variable 'assertion_operand_a09eb6acc6c64972932d4590f3213315_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_a09eb6acc6c64972932d4590f3213315_0' to true")
