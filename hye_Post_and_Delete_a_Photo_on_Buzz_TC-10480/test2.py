...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_7815f7c88b6c4b47b9a48d5289a22c0f_0' to true
    assertion_operand_7815f7c88b6c4b47b9a48d5289a22c0f_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 11 : Type in What's on your mind? input textarea 'post with uploaded photo'
    element_locators = ['[placeholder="What\'s on your mind?"]', '.oxd-buzz-post--focus > textarea', '.oxd-buzz-post--focus > textarea:nth-child(1)', '.oxd-buzz-post--focus > textarea:nth-child(1)', "//div[contains(@class,'oxd-buzz-post--focus')]/textarea[1]", "//div[contains(@class,'oxd-buzz-post--focus')]/textarea[1]"]
    element = get_element(driver,element_locators)
    ...
    driver.execute_script("arguments[0].value = '';", element)
    if element.get_attribute("pattern") and '[0-9]{2}' in element.get_attribute("pattern"):
        for char in 'post with uploaded photo':
            element.send_keys(char)
    else:
        element.send_keys('post with uploaded photo')
    driver.implicitly_wait(6)

    # Step - 12 : Click on the Share Photos button with camera icon
    ...
    # Step - 13 : Upload file from variable 'FILE_Screenshot_2025_09_12_at_7_19_03_E2_80_AFPM_png'
    ...
    # Step - 14 : Click on the Share button in Share Photos popup
    ...
    # Step - 15 : Query 'post with upload photo' visibility
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 16 : set the value of variable 'assertion_operand_2b726603a61e4075acb090d683dfac53_0' to true
    assertion_operand_2b726603a61e4075acb090d683dfac53_0 = "true"
    driver.implicitly_wait(6)

    # Step - 17 : Assert 'post with upload photo' text is visible
    assertion_operand_2b726603a61e4075acb090d683dfac53_0 = "true"
    driver.implicitly_wait(6)

    # Step - 18 : Click on the three dots menu icon on post by Pushpa Raj
    ...
    # Step - 19 : Click on Delete Post option in post header menu
    element_locators = ['[role="menu"] > li:nth-child(1)', '[role="menu"] > li:nth-child(1)', '[role="menu"] > li:nth-child(1)', "//div[contains(@class,'orangehrm-buzz-post-header-config')]/li[1]/ul[1]/li[1]", "//div[contains(@class,'orangehrm-buzz-post-header-config')]/li[1]/ul[1]/li[1]"]
    element = get_element(driver,element_locators)
    ...
    # Step - 20 : Click on 'Yes, Delete' button with trash icon
