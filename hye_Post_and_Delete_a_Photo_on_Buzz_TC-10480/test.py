...
class FirstSampleTest(unittest.TestCase):
    ...
    def test_demo_site(self):
        ...
        try:
            ...
            # Type in What's on your mind? input textarea 'post with uploaded photo'
            lambda_hooks(driver, f"type {UIActions.operations_meta_data['2']['value']}")
            ui_action(driver = driver, operation_index = str(2))

            # Click on the Share Photos button with camera icon
            lambda_hooks(driver, "Click on the Share Photos button with camera icon")
            ...
            # Query 'post with upload photo' visibility
            lambda_hooks(driver, "Query 'post with upload photo' visibility")
            post_with_upload_photo_visible = vision_query(driver = driver, operation_index = str(6))
            if isinstance(post_with_upload_photo_visible, dict):
                post_with_upload_photo_visible = post_with_upload_photo_visible.get("vision_query")
            user_variables["post_with_upload_photo_visible"] =  post_with_upload_photo_visible
            print("post_with_upload_photo_visible:", post_with_upload_photo_visible)

            # set the value of variable 'assertion_operand_2b726603a61e4075acb090d683dfac53_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_2b726603a61e4075acb090d683dfac53_0' to true")
            ...
            # Click on Delete Post option in post header menu
            lambda_hooks(driver, "Click on Delete Post option in post header menu")
