...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_4ed6ee1917734984b39c8d7aba721aaa_0' to true
    assertion_operand_4ed6ee1917734984b39c8d7aba721aaa_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 15 : set the value of variable 'assertion_operand_0e7b897e07d04ae38af54137296567bb_0' to jobCategory
    assertion_operand_0e7b897e07d04ae38af54137296567bb_0 = "jobCategory"
    driver.implicitly_wait(6)

    # Step - 16 : Assert '{{url}}' contains 'jobCategory'
    assertion_operand_0e7b897e07d04ae38af54137296567bb_0 = "jobCategory"
    driver.implicitly_wait(6)

    # Step - 17 : Query '+ Add' button visibility
    ...
    # Step - 18 : set the value of variable 'assertion_operand_186962da999e4f9a9e6c2d16551a8589_0' to true
    assertion_operand_186962da999e4f9a9e6c2d16551a8589_0 = "true"
    driver.implicitly_wait(6)

    # Step - 19 : Assert '+ Add' button is displayed
    assertion_operand_186962da999e4f9a9e6c2d16551a8589_0 = "true"
