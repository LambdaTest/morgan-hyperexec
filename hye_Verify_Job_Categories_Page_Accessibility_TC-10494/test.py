...
class FirstSampleTest(unittest.TestCase):
    ...
    def test_demo_site(self):
        ...
        try:
            ...
            # Click 'Job Categories' from the dropdown
            lambda_hooks(driver, "Click 'Job Categories' from the dropdown")
            ...
            # set the value of variable 'assertion_operand_0e7b897e07d04ae38af54137296567bb_0' to jobCategory
            lambda_hooks(driver, "set the value of variable 'assertion_operand_0e7b897e07d04ae38af54137296567bb_0' to jobCategory")
            ...
            add_button_visible = vision_query(driver = driver, operation_index = str(8))
            ...
            # set the value of variable 'assertion_operand_186962da999e4f9a9e6c2d16551a8589_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_186962da999e4f9a9e6c2d16551a8589_0' to true")
