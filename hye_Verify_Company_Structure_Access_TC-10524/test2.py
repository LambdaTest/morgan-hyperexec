...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_e8b80ff034c34686bc482896feac4b2f_0' to true
    assertion_operand_e8b80ff034c34686bc482896feac4b2f_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 14 : set the value of variable 'assertion_operand_605680a15c95415fbc1391d15873dc5c_0' to viewCompanyStructure
    assertion_operand_605680a15c95415fbc1391d15873dc5c_0 = "viewCompanyStructure"
    driver.implicitly_wait(6)

    # Step - 15 : Assert '{{url}}' contains 'viewCompanyStructure'
    assertion_operand_605680a15c95415fbc1391d15873dc5c_0 = "viewCompanyStructure"
    driver.implicitly_wait(6)

    # Step - 16 : Query 'NetFunda' text visibility
    element_locators = ["//div[@id='app']/div[1]/div[2]/div[2]/div[1]/div[1]/div[2]/p[1]", 'p:has(+ .oxd-button--medium)', 'p:has(+ .oxd-button--secondary)', 'p:has(+ .oxd-button--medium.oxd-button--secondary)', '#app > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(3) > p:nth-child(1)', "//p[text()='NetFunda']"]
    element = get_element(driver,element_locators)

    'This Instruction Is Carried Out By The Vision Model'
    driver.implicitly_wait(6)

    # Step - 17 : set the value of variable 'assertion_operand_f8ca24bc53e64d76a55e69e50d2926bc_0' to true
    assertion_operand_f8ca24bc53e64d76a55e69e50d2926bc_0 = "true"
    driver.implicitly_wait(6)

    # Step - 18 : Assert 'NetFunda' text is displayed
    assertion_operand_f8ca24bc53e64d76a55e69e50d2926bc_0 = "true"
