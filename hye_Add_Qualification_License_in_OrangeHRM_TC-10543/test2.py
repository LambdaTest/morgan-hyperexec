...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_812696c9792848f480b44bf07f6f423f_0' to true
    assertion_operand_812696c9792848f480b44bf07f6f423f_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 17 : set the value of variable 'assertion_operand_0f59fb8d3be64d3686a8dd273afac02e_0' to true
    assertion_operand_0f59fb8d3be64d3686a8dd273afac02e_0 = "true"
    driver.implicitly_wait(6)

    # Step - 18 : Assert 'Required' text is displayed on viewport
    assertion_operand_0f59fb8d3be64d3686a8dd273afac02e_0 = "true"
    driver.implicitly_wait(6)

    # Step - 19 : type 'abc' in name field
