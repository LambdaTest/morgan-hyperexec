...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_60dbacd0e6e04764ae807ab6612cd19c_0' to true
    assertion_operand_60dbacd0e6e04764ae807ab6612cd19c_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 13 : Click on the three dots menu icon on the post by Pushpa Raj
    ...
    # Step - 14 : Click on 'Edit Post' option in post action menu
    element_locators = ["//p[text()='Edit Post']", '[role="menu"] > li:nth-child(2) > p:nth-child(2)', '[role="menu"] > li:nth-child(2) > p:nth-child(2)', "//div[contains(@class,'orangehrm-buzz-post-header-config')]/li[1]/ul[1]/li[2]/p[1]", "//div[contains(@class,'orangehrm-buzz-post-header-config')]/li[1]/ul[1]/li[2]/p[1]"]
    element = get_element(driver,element_locators)
    ...
    # Step - 15 : Click on the post content textarea in edit post popup
    ...
    # Step - 16 : Type in post edit text area 'edit comment with photo upload'
    element_locators = ['.oxd-buzz-post--focus > textarea', '.oxd-buzz-post--focus > textarea:nth-child(1)', '.oxd-buzz-post--focus > textarea:nth-child(1)', "//div[contains(@class,'oxd-buzz-post--focus')]/textarea[1]", "//div[contains(@class,'oxd-buzz-post--focus')]/textarea[1]"]
    element = get_element(driver,element_locators)
    ...
    driver.execute_script("arguments[0].value = '';", element)
    if element.get_attribute("pattern") and '[0-9]{2}' in element.get_attribute("pattern"):
        for char in 'edit comment with photo upload':
            element.send_keys(char)
    else:
        element.send_keys('edit comment with photo upload')
    driver.implicitly_wait(6)

    # Step - 17 : Click on the Post button in edit post popup
    element_locators = ['.orangehrm-buzz-post-modal-actions > button', '.orangehrm-buzz-post-modal-actions > button:nth-child(1)', '.orangehrm-buzz-post-modal-actions > button:nth-child(1)', "//div[contains(@class,'orangehrm-buzz-post-modal-actions')]/button[1]", "//div[contains(@class,'orangehrm-buzz-post-modal-actions')]/button[1]"]
    element = get_element(driver,element_locators)
    ...
    # Step - 18 : Query 'edit comment with photo upload' text visibility
    element_locators = ['.orangehrm-buzz-post-body-text', '.oxd-text--p.orangehrm-buzz-post-body-text', 'p:has(+ .orangehrm-buzz-post-body-readmore)', "//div[@id='app']/div[1]/div[2]/div[2]/div[1]/div[1]/div[1]/div[3]/div[1]/div[1]/div[2]/div[1]/p[1]", "//p[text()='edit comment with photo upload']", 'p:has(+ .oxd-text--p.orangehrm-buzz-post-body-readmore)', "//p[contains(@class,'orangehrm-buzz-post-body-text')]", "//p[contains(@class,'oxd-text--p') and contains(@class,'orangehrm-buzz-post-body-text')]"]
    element = get_element(driver,element_locators)

    'This Instruction Is Carried Out By The Vision Model'
    driver.implicitly_wait(6)

    # Step - 19 : set the value of variable 'assertion_operand_c1b2ba50ef7a4df08f32cb7186c6c3bb_0' to true
    assertion_operand_c1b2ba50ef7a4df08f32cb7186c6c3bb_0 = "true"
    driver.implicitly_wait(6)

    # Step - 20 : Assert 'edit comment with photo upload' text is visible
    assertion_operand_c1b2ba50ef7a4df08f32cb7186c6c3bb_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 22 : Click on 'Delete Post' option in post menu
