...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_caa8b4870b374a39acfaeb5c694b7a10_0' to true
    assertion_operand_caa8b4870b374a39acfaeb5c694b7a10_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 13 : Click 'Language' dropdown
    element_locators = ["//div[@id='app']/div[1]/div[2]/div[2]/div[1]/div[1]/form[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]", '#app > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > form:nth-child(3) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1)', "//div[text()='English (United States)']", "//div[contains(text(),'English (United States)')]"]
    element = get_element(driver,element_locators)
    ...
    # Step - 14 : Click first option in dropdown
    ...
    # Step - 15 : Query 'chinese' text visibility
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 16 : set the value of variable 'assertion_operand_a375f94271a741b0981655b2d707e17f_0' to true
    assertion_operand_a375f94271a741b0981655b2d707e17f_0 = "true"
    driver.implicitly_wait(6)

    # Step - 17 : Assert 'chinese' text is visible on the viewport
    assertion_operand_a375f94271a741b0981655b2d707e17f_0 = "true"
