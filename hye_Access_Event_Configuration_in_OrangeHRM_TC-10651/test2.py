...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_3b23f904b04c40d2a77e013e73937a9c_0' to true
    assertion_operand_3b23f904b04c40d2a77e013e73937a9c_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 9 : Click on Claim menu item in left sidebar
    ...
    # Step - 10 : Click on Configuration tab in the top nav bar
    ...
    # Step - 11 : Click on 'Events' tab in the top filter bar
    ...
    # Step - 13 : set the value of variable 'assertion_operand_fed78cfcf9e54829a16b61df40df1bac_0' to ViewEvents
    assertion_operand_fed78cfcf9e54829a16b61df40df1bac_0 = "ViewEvents"
    driver.implicitly_wait(6)

    # Step - 14 : Assert current URL contains 'ViewEvents'
    assertion_operand_fed78cfcf9e54829a16b61df40df1bac_0 = "ViewEvents"
    driver.implicitly_wait(6)

    # Step - 15 : Click on the collapse events section icon in top right
    element_locators = ['.oxd-table-filter-header-options > div:nth-child(3) > button:nth-child(1) > i:nth-child(1)', '.oxd-table-filter-header-options > div:nth-child(3) > button:nth-child(1) > i:nth-child(1)', "//div[contains(@class,'oxd-table-filter-header-options')]/div[3]/button[1]/i[1]", "//div[contains(@class,'oxd-table-filter-header-options')]/div[3]/button[1]/i[1]"]
    element = get_element(driver,element_locators)
    ...
    # Step - 16 : Click on the dropdown caret icon on the right of Events header
    element_locators = ['.oxd-table-filter-header-options > div:nth-child(3) > button:nth-child(1) > i:nth-child(1)', '.oxd-table-filter-header-options > div:nth-child(3) > button:nth-child(1) > i:nth-child(1)', "//div[contains(@class,'oxd-table-filter-header-options')]/div[3]/button[1]/i[1]", "//div[contains(@class,'oxd-table-filter-header-options')]/div[3]/button[1]/i[1]"]
    element = get_element(driver,element_locators)
