...
class FirstSampleTest(unittest.TestCase):
    ...
    def test_demo_site(self):
        ...
        try:
            ...
            # Click on 'Expense Types' tab in the Configuration dropdown
            lambda_hooks(driver, "Click on 'Expense Types' tab in the Configuration dropdown")
            ...
            # Type in expense name input field with placeholder 'Type for hints...' 'active'
            lambda_hooks(driver, f"type {UIActions.operations_meta_data['4']['value']}")
            ui_action(driver = driver, operation_index = str(4))

            # Click on the status dropdown in expense types filter
            lambda_hooks(driver, "Click on the status dropdown in expense types filter")
            ...
            # set the value of variable 'assertion_operand_b4b260dd99274522a45dfb2c64458c70_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_b4b260dd99274522a45dfb2c64458c70_0' to true")
            ...
            # Click on the checkbox for Active Expense name in the records list
            lambda_hooks(driver, "Click on the checkbox for Active Expense name in the records list")
            ...
            # set the value of variable 'assertion_operand_0086cc65081f42f09f7a8ff161a4655d_0' to true
            lambda_hooks(driver, "set the value of variable 'assertion_operand_0086cc65081f42f09f7a8ff161a4655d_0' to true")
            ...
            # Click on the checkbox for Active Expense name in the expense list
            lambda_hooks(driver, "Click on the checkbox for Active Expense name in the expense list")
            ui_action(driver = driver, operation_index = str(14))

            # Click on the Reset button in Expense Types filter section
            lambda_hooks(driver, "Click on the Reset button in Expense Types filter section")
