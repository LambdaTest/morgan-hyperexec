...
try:
    ...
    # Step - 3 : set the value of variable 'assertion_operand_0e743713f46d480a8c25637c483437e4_0' to true
    assertion_operand_0e743713f46d480a8c25637c483437e4_0 = "true"
    driver.implicitly_wait(6)
    ...
    # Step - 14 : set the value of variable 'assertion_operand_7d71853cad954b8987005347d8a6e6fe_0' to addEmployee
    assertion_operand_7d71853cad954b8987005347d8a6e6fe_0 = "addEmployee"
    driver.implicitly_wait(6)

    # Step - 15 : Assert '{{url}}' contains 'addEmployee'
    assertion_operand_7d71853cad954b8987005347d8a6e6fe_0 = "addEmployee"
    driver.implicitly_wait(6)
    ...
    # Step - 17 : Query if 'Required' text is visible
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 18 : set the value of variable 'assertion_operand_0affd9d9277b4e4cbf032a412dacd5e3_0' to true
    ...
    # Step - 20 : Query 'Add Employee' text visibility
    element_locators = ['']
    element = get_element(driver,element_locators)
    ...
    # Step - 25 : Query 'Employee Information' text visibility
    ...
    # Step - 26 : set the value of variable 'assertion_operand_8ae9aa2eea0244df9f594b0f34ea87a9_0' to true
    assertion_operand_8ae9aa2eea0244df9f594b0f34ea87a9_0 = "true"
    driver.implicitly_wait(6)

    # Step - 27 : Assert 'Employee Information' text is displayed
    assertion_operand_8ae9aa2eea0244df9f594b0f34ea87a9_0 = "true"
